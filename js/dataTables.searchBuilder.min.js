...
"pm";c.s.d.setUTCHours(b===12&&!f?0:f&&b!==12?b+12:b)}else c.s.d.setUTCHours(f);c._setTime();c._writeOutput(true);d()}else if(b.hasClass(e+"-minutes")){c.s.d.setUTCMinutes(f);c._setTime();c._writeOutput(true);d()}else if(b.hasClass(e+"-seconds")){c.s.d.setSeconds(f);c._setTime();c._writeOutput(true);d()}c.dom.input.focus();c._position()}).on("click",function(b){var f=c.s.d,h=b.target.nodeName.toLowerCase(),k=h==="span"?b.target.parentNode:b.target,h=k.nodeName.toLowerCase();if(h!=="select"){b.stopPropagation();
if(h==="button"){k=a(k);b=k.parent();if(b.hasClass("disabled")&&!b.hasClass("range"))k.blur();else if(b.hasClass(e+"-iconLeft")){c.s.display.setUTCMonth(c.s.display.getUTCMonth()-1);c._setTitle();c._setCalander();c.dom.input.focus()}else if(b.hasClass(e+"-iconRight")){c._correctMonth(c.s.display,c.s.display.getUTCMonth()+1);c._setTitle();c._setCalander();c.dom.input.focus()}else{if(k.parents("."+e+"-time").length){h=k.data("value");k=k.data("unit");if(k==="minutes"){if(b.hasClass("disabled")&&b.hasClass("range")){c.s.minutesRange=
h;c._setTime();return}c.s.minutesRange=null}if(k==="seconds"){if(b.hasClass("disabled")&&b.hasClass("range")){c.s.secondsRange=h;c._setTime();return}c.s.secondsRange=null}if(h==="am")if(f.getUTCHours()>=12)h=f.getUTCHours()-12;else return;else if(h==="pm")if(f.getUTCHours()<12)h=f.getUTCHours()+12;else return;f[k==="hours"?"setUTCHours":k==="minutes"?"setUTCMinutes":"setSeconds"](h);c._setTime();c._writeOutput(true)}else{f||(f=c._dateToUtc(new Date));f.setUTCDate(1);f.setUTCFullYear(k.data("year"));
f.setUTCMonth(k.data("month"));f.setUTCDate(k.data("day"));c._writeOutput(true);c.s.parts.time?c._setCalander():setTimeout(function(){c._hide()},10)}d()}}else c.dom.input.focus()}})},_compareDates:function(a,b){return this._dateToUtcString(a)===this._dateToUtcString(b)},_correctMonth:function(a,b){var c=this._daysInMonth(a.getUTCFullYear(),b),e=a.getUTCDate()>c;a.setUTCMonth(b);e&&(a.setUTCDate(c),a.setUTCMonth(b))},_daysInMonth:function(a,b){return[31,0===a%4&&(0!==a%100||0===a%400)?29:28,31,30,
...
c){var e=this._dateToUtc(new Date),d=this._daysInMonth(b,c),f=(new Date(Date.UTC(b,c,1))).getUTCDay(),h=[],k=[];0<this.c.firstDay&&(f-=this.c.firstDay,0>f&&(f+=7));for(var g=d+f,i=g;7<i;)i-=7;var g=g+(7-i),j=this.c.minDate,i=this.c.maxDate;j&&(j.setUTCHours(0),j.setUTCMinutes(0),j.setSeconds(0));i&&(i.setUTCHours(23),i.setUTCMinutes(59),i.setSeconds(59));for(var l=0,n=0;l<g;l++){var m=new Date(Date.UTC(b,c,1+(l-f))),p=this.s.d?this._compareDates(m,this.s.d):!1,A=this._compareDates(m,e),o=l<f||l>=
d+f,q=j&&m<j||i&&m>i,w=this.c.disableDays;Array.isArray(w)&&-1!==a.inArray(m.getUTCDay(),w)?q=!0:"function"===typeof w&&!0===w(m)&&(q=!0);k.push(this._htmlDay({day:1+(l-f),month:c,year:b,selected:p,today:A,disabled:q,empty:o}));7===++n&&(this.c.showWeekNumber&&k.unshift(this._htmlWeekOfYear(l-f,c,b)),h.push("<tr>"+k.join("")+"</tr>"),k=[],n=0)}e=this.c.classPrefix;d=e+"-table";this.c.showWeekNumber&&(d+=" weekNumber");j&&(j=j>=new Date(Date.UTC(b,c,1,0,0,0)),this.dom.title.find("div."+e+"-iconLeft").css("display",
j?"none":"block"));i&&(i=i<new Date(Date.UTC(b,c+1,1,0,0,0)),this.dom.title.find("div."+e+"-iconRight").css("display",i?"none":"block"));return'<table class="'+d+'"><thead>'+this._htmlMonthHead()+"</thead><tbody>"+h.join("")+"</tbody></table>"},_htmlMonthHead:function(){var a=[],b=this.c.firstDay,c=this.c.i18n,e=function(a){for(a+=b;7<=a;)a-=7;return c.weekdays[a]};this.c.showWeekNumber&&a.push("<th></th>");for(var d=0;7>d;d++)a.push("<th>"+e(d)+"</th>");return a.join("")},_htmlWeekOfYear:function(a,
...
c.find("option:selected");e.html(0!==c.length?c.text():this.c.i18n.unknown)},_optionsTime:function(b,c,e,d,f){var h=this.c.classPrefix,k=this.dom.container.find("div."+h+"-"+b),g,i=12===c?function(a){return a}:this._pad,h=this.c.classPrefix,j=h+"-table",l=this.c.i18n;if(k.length){var n="";g=10;var m=function(f,k,g){12===c&&"number"===typeof f&&(12<=e&&(f+=12),12==f?f=0:24==f&&(f=12));var i=e===f||"am"===f&&12>e||"pm"===f&&12<=e?"selected":"";d&&-1===a.inArray(f,d)&&(i+=" disabled");g&&(i+=" "+g);
return'<td class="selectable '+i+'"><button class="'+h+"-button "+h+'-day" type="button" data-unit="'+b+'" data-value="'+f+'"><span>'+k+"</span></button></td>"};if(12===c){n+="<tr>";for(f=1;6>=f;f++)n+=m(f,i(f));n+=m("am",l.amPm[0]);n+="</tr><tr>";for(f=7;12>=f;f++)n+=m(f,i(f));n+=m("pm",l.amPm[1]);n+="</tr>";g=7}else{if(24===c){var p=0;for(g=0;4>g;g++){n+="<tr>";for(f=0;6>f;f++)n+=m(p,i(p)),p++;n+="</tr>"}}else{n+="<tr>";for(g=0;60>g;g+=10)n+=m(g,i(g),"range");f=null!==f?f:10*Math.floor(e/10);n=
n+"</tr>"+('</tbody></thead><table class="'+j+" "+j+'-nospace"><tbody>')+"<tr>";for(g=f+1;g<f+10;g++)n+=m(g,i(g));n+="</tr>"}g=6}k.empty().append('<table class="'+j+'"><thead><tr><th colspan="'+g+'">'+l[b]+"</th></tr></thead><tbody>"+n+"</tbody></table>")}},_optionsTitle:function(){var a=this.c.i18n,b=this.c.minDate,c=this.c.maxDate,b=b?b.getFullYear():null,c=c?c.getFullYear():null,b=null!==b?b:(new Date).getFullYear()-this.c.yearRange,c=null!==c?c:(new Date).getFullYear()+this.c.yearRange;this._options("month",
...
yearRange:25};f.version="1.0.1";b.DateTime||(b.DateTime=f);a.fn.dtDateTime=function(a){return this.each(function(){new f(this,a)})};a.fn.dataTable&&(a.fn.dataTable.DateTime=f,a.fn.DataTable.DateTime=f);return f};"function"===typeof define&&define.amd?define(["jquery"],function(a){return y(a,window,document)}):"object"===typeof exports?module.exports=function(a,b){a||(a=window);return y(b,a,a.document)}:y(jQuery,window,document);var f,q,p=window.moment,o=window.luxon,l,d=function(a,b,c,e,h){var k=
...
f(this.dom.condition).addClass(this.classes.greyscale);f(this.dom.defaultValue).addClass(this.classes.greyscale);a=0;for(c=this.dom.value;a<c.length;a++)f(c[a]).addClass(this.classes.greyscale)}this.s.dt.on("draw.dtsp",function(){k._adjustCriteria()});this.s.dt.on("buttons-action",function(){k._adjustCriteria()});f(window).on("resize.dtsp",q.util.throttle(function(){k._adjustCriteria()}));this._buildCriteria();return this};d.prototype.updateArrows=function(a,b){void 0===a&&(a=!1);void 0===b&&(b=!0);
...
f(this.dom.conditionTitle).remove();var k;f(this.dom.condition).children("option").each(function(){void 0!==a.condition&&(f(this).val()===a.condition&&"string"===typeof a.condition)&&(f(this).attr("selected",!0),k=f(this).val())});this.s.condition=k;void 0!==this.s.condition?(f(this.dom.conditionTitle).remove(),f(this.dom.condition).removeClass(this.classes.italic),this._populateValue(a)):f(this.dom.conditionTitle).prependTo(this.dom.condition).attr("selected",!0)}};d.prototype.setListeners=function(){var a=
...
b;a=this.dom.value[this.dom.value.length-1];if(0!==f(this.dom.container).has(a).length){b=f(a).outerWidth(!0);a=f(a).offset().left+b;var c=f(this.dom.left).offset(),e=f(this.dom.right).offset(),d=f(this.dom["delete"]).offset(),k=0!==f(this.dom.container).has(this.dom.left).length,g=0!==f(this.dom.container).has(this.dom.right).length,i=k?c.left:g?e.left:d.left;(15>i-a||k&&c.top!==d.top||g&&e.top!==d.top)&&!f(this.dom.container).parent().hasClass(this.classes.vertical)?(f(this.dom.container).parent().addClass(this.classes.vertical),
...
""):-1!==this.s.type.indexOf("luxon")&&(this.s.dateFormat=this.s.type.replace(/luxon\-/g,""));for(var e=0,d=Object.keys(c);e<d.length;e++){var k=d[e];null!==c[k]&&(this.s.conditions[k]=c[k],b=c[k].conditionName,"function"===typeof b&&(b=b(this.s.dt,this.c.i18n)),a.push(f("<option>",{text:b,value:k}).addClass(this.classes.option).addClass(this.classes.notItalic)))}}else if(0<b){f(this.dom.condition).empty().attr("disabled",!1).addClass(this.classes.italic);c=0;for(e=Object.keys(this.s.conditions);c<
e.length;c++)k=e[c],b=this.s.conditions[k].conditionName,"function"===typeof b&&(b=b(this.s.dt,this.c.i18n)),k=f("<option>",{text:b,value:k}).addClass(this.classes.option).addClass(this.classes.notItalic),void 0!==this.s.condition&&this.s.condition===b&&(f(k).attr("selected",!0),f(this.dom.condition).removeClass(this.classes.italic)),a.push(k)}else{f(this.dom.condition).attr("disabled",!0).addClass(this.classes.italic);return}for(b=0;b<a.length;b++)k=a[b],f(this.dom.condition).append(k);f(this.dom.condition).prop("selectedIndex",
...
condition:"dtsb-condition",container:"dtsb-criteria",data:"dtsb-data","delete":"dtsb-delete",dropDown:"dtsb-dropDown",greyscale:"dtsb-greyscale",input:"dtsb-input",italic:"dtsb-italic",joiner:"dtsp-joiner",left:"dtsb-left",notItalic:"dtsb-notItalic",option:"dtsb-option",right:"dtsb-right",select:"dtsb-select",value:"dtsb-value",vertical:"dtsb-vertical"};d.initSelect=function(a,b,c,e){void 0===c&&(c=null);void 0===e&&(e=!1);var h=f(a.dom.data).children("option:selected").val(),g=a.s.dt.rows().indexes().toArray(),
i=a.s.dt.settings()[0],j=f("<select/>").addClass(d.classes.value).addClass(d.classes.dropDown).addClass(d.classes.italic).addClass(d.classes.select).append(a.dom.valueTitle).on("input change",function(){f(this).removeClass(d.classes.italic);b(a,this)});a.c.greyscale&&f(j).addClass(d.classes.greyscale);for(var l=[],m=[],p=0;p<g.length;p++){var o=g[p],r=i.oApi._fnGetCellData(i,o,h,"string"===typeof a.c.orthogonal?a.c.orthogonal:a.c.orthogonal.search),r="string"===typeof r?r.replace(/[\r\n\u2028]/g,
" "):r,o=i.oApi._fnGetCellData(i,o,h,"string"===typeof a.c.orthogonal?a.c.orthogonal:a.c.orthogonal.display);"array"===a.s.type&&(r=!Array.isArray(r)?[r]:r=r.sort(),o=!Array.isArray(o)?[o]:o=o.sort());var q=function(b,e){var h=f("<option>",{type:Array.isArray(b)?"Array":"String",value:a.s.type.indexOf("html")!==-1&&b!==null&&typeof b==="string"?b.replace(/(<([^>]+)>)/ig,""):b}).addClass(a.classes.option).addClass(a.classes.notItalic).html(typeof e==="string"?e.replace(/(<([^>]+)>)/ig,""):e),g=f(h).val();
if(l.indexOf(g)===-1){l.push(g);m.push(h);c!==null&&Array.isArray(c[0])&&(c[0]=c[0].sort().join(","));if(c!==null&&h.val()===c[0]){h.attr("selected",true);f(j).removeClass(d.classes.italic)}}};if(e)for(var s=0;s<r.length;s++)q(r[s],o[s]);else q(r,o)}m.sort(function(b,c){if("string"===a.s.type||"num"===a.s.type||"html"===a.s.type||"html-num"===a.s.type)return f(b).val()<f(c).val()?-1:f(b).val()<f(c).val()?1:0;if("num-fmt"===a.s.type||"html-num-fmt"===a.s.type)return+f(b).val().replace(/[^0-9.]/g,"")<
+f(c).val().replace(/[^0-9.]/g,"")?-1:+f(b).val().replace(/[^0-9.]/g,"")<+f(c).val().replace(/[^0-9.]/g,"")?1:0});for(e=0;e<m.length;e++)h=m[e],f(j).append(h);return j};d.initSelectArray=function(a,b,c){void 0===c&&(c=null);return d.initSelect(a,b,c,!0)};d.initInput=function(a,b,c){var e=this;void 0===c&&(c=null);var h=a.s.dt.settings()[0].searchDelay,h=f("<input/>").addClass(d.classes.value).addClass(d.classes.input).on("input",null!==h?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,
...
search:function(a,b,c){return p(a,c.s.dateFormat).valueOf()===p(b[0],c.s.dateFormat).valueOf()}},"!=":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.not",b.conditions.date.not)},init:d.initDate,inputValue:d.inputValueInput,isInputValid:d.isInputValidInput,search:function(a,b,c){return p(a,c.s.dateFormat).valueOf()!==p(b[0],c.s.dateFormat).valueOf()}},"<":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.before",b.conditions.date.before)},init:d.initDate,
...
b.conditions.date.between)},init:d.init2Date,inputValue:d.inputValueInput,isInputValid:d.isInputValidInput,search:function(a,b,c){var a=p(a,c.s.dateFormat).valueOf(),e=p(b[0],c.s.dateFormat).valueOf(),b=p(b[1],c.s.dateFormat).valueOf();return e<b?e<=a&&a<=b:b<=a&&a<=e}},"!between":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.notBetween",b.conditions.date.notBetween)},init:d.init2Date,inputValue:d.inputValueInput,isInputValid:d.isInputValidInput,search:function(a,b,c){var a=
p(a,c.s.dateFormat).valueOf(),e=p(b[0],c.s.dateFormat).valueOf(),b=p(b[1],c.s.dateFormat).valueOf();return e<b?!(+e<=+a&&+a<=+b):!(+b<=+a&&+a<=+e)}},"null":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.empty",b.conditions.date.empty)},isInputValid:function(){return!0},init:d.initNoValue,inputValue:function(){},search:function(a){return null===a||void 0===a||0===a.length}},"!null":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.notEmpty",b.conditions.date.notEmpty)},
isInputValid:function(){return!0},init:d.initNoValue,inputValue:function(){},search:function(a){return!(null===a||void 0===a||0===a.length)}}};d.luxonDateConditions={"=":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.equals",b.conditions.date.equals)},init:d.initDate,inputValue:d.inputValueInput,isInputValid:d.isInputValidInput,search:function(a,b,c){return o.DateTime.fromFormat(a,c.s.dateFormat).ts===o.DateTime.fromFormat(b[0],c.s.dateFormat).ts}},"!=":{conditionName:function(a,
b){return a.i18n("searchBuilder.conditions.date.not",b.conditions.date.not)},init:d.initDate,inputValue:d.inputValueInput,isInputValid:d.isInputValidInput,search:function(a,b,c){return o.DateTime.fromFormat(a,c.s.dateFormat).ts!==o.DateTime.fromFormat(b[0],c.s.dateFormat).ts}},"<":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.before",b.conditions.date.before)},init:d.initDate,inputValue:d.inputValueInput,isInputValid:d.isInputValidInput,search:function(a,b,c){return o.DateTime.fromFormat(a,
c.s.dateFormat).ts<o.DateTime.fromFormat(b[0],c.s.dateFormat).ts}},">":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.after",b.conditions.date.after)},init:d.initDate,inputValue:d.inputValueInput,isInputValid:d.isInputValidInput,search:function(a,b,c){return o.DateTime.fromFormat(a,c.s.dateFormat).ts>o.DateTime.fromFormat(b[0],c.s.dateFormat).ts}},between:{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.between",b.conditions.date.between)},init:d.init2Date,
inputValue:d.inputValueInput,isInputValid:d.isInputValidInput,search:function(a,b,c){var a=o.DateTime.fromFormat(a,c.s.dateFormat).ts,e=o.DateTime.fromFormat(b[0],c.s.dateFormat).ts,b=o.DateTime.fromFormat(b[1],c.s.dateFormat).ts;return e<b?e<=a&&a<=b:b<=a&&a<=e}},"!between":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.notBetween",b.conditions.date.notBetween)},init:d.init2Date,inputValue:d.inputValueInput,isInputValid:d.isInputValidInput,search:function(a,b,c){var a=
o.DateTime.fromFormat(a,c.s.dateFormat).ts,e=o.DateTime.fromFormat(b[0],c.s.dateFormat).ts,b=o.DateTime.fromFormat(b[1],c.s.dateFormat).ts;return e<b?!(+e<=+a&&+a<=+b):!(+b<=+a&&+a<=+e)}},"null":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.empty",b.conditions.date.empty)},isInputValid:function(){return!0},init:d.initNoValue,inputValue:function(){},search:function(a){return null===a||void 0===a||0===a.length}},"!null":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.notEmpty",
...
this.s.criteria.length)return!0;for(var c=!1,e=0,d=this.s.criteria;e<d.length;e++){var f=d[e];if(f.criteria instanceof l&&f.criteria.s.filled){if(c=!0,f.criteria.search(a,b))return!0}else if(f.criteria instanceof j&&f.criteria.checkFilled()&&(c=!0,f.criteria.search(a,b)))return!0}return!c};j.prototype._removeCriteria=function(a,b){void 0===b&&(b=!1);if(1>=this.s.criteria.length&&this.s.isChild)this.destroy();else{for(var c=void 0,e=0;e<this.s.criteria.length;e++)if(this.s.criteria[e].index===a.s.index&&
...
a.s;b.s.toDrop.c=a.c;b.s.toDrop.classes=a.classes;b.s.toDrop.populate();var c=b.s.toDrop.s.index;g(b.dom.container).trigger("dtsb-dropCriteria");a.s.index=c;b._removeCriteria(a);g(b.s.topGroup).trigger("dtsb-redrawContents");b.s.dt.draw();return!1})};j.prototype._setClearListener=function(){var a=this;g(this.dom.clear).unbind("click").on("click",function(){if(!a.s.isChild)return g(a.dom.container).trigger("dtsb-clearContents"),!1;a.destroy();g(a.s.topGroup).trigger("dtsb-updateTitle");g(a.s.topGroup).trigger("dtsb-redrawContents");
...
value:"Value",valueJoiner:"and"},logic:"AND",orthogonal:{display:"display",search:"filter"},preDefined:!1};v=j;var i,s,x,m=function(a,b){var c=this;if(!s||!s.versionCheck||!s.versionCheck("1.10.0"))throw Error("SearchBuilder requires DataTables 1.10 or newer");if(!s.DateTime)throw Error("SearchPane requires DateTime");var e=new s.Api(a);this.classes=i.extend(!0,{},m.classes);this.c=i.extend(!0,{},m.defaults,b);this.dom={clearAll:i('<button type="button">'+e.i18n("searchBuilder.clearAll",this.c.i18n.clearAll)+
...
e.s.dt.columns().every(function(c){if(b.s.dt.settings()[0].aoColumns[c].sTitle===a.data)a.dataIdx=c})},e=this,d=0,f=a.criteria;d<f.length;d++)c(f[d]);return a};m.prototype._setUp=function(a){var b=this;void 0===a&&(a=!0);this.s.topGroup=new v(this.s.dt,this.c,void 0);this._setClearListener();this.s.dt.on("stateSaveParams",function(a,e,d){d.searchBuilder=b.getDetails();d.page=b.s.dt.page()});this._build();a&&(a=this.s.dt.state.loaded(),null!==a&&void 0!==a.searchBuilder?(this.s.topGroup.rebuild(a.searchBuilder),
...
leftTitle:"Outdent criteria",logicAnd:"And",logicOr:"Or",rightTitle:"Indent criteria",title:{"0":"Custom Search Builder",_:"Custom Search Builder (%d)"},value:"Value",valueJoiner:"and"},logic:"AND",orthogonal:{display:"display",search:"filter"},preDefined:!1};x=m;var z=function(a,b,c){function d(a,b){var c=new h.Api(a),e=b?b:c.init().searchBuilder||h.defaults.searchBuilder;return(new x(c,e)).getNode()}i=a;s=a.fn.DataTable;g=a;u=a.fn.dataTable;f=a;var h=q=a.fn.dataTable;a.fn.dataTable.SearchBuilder=
x;a.fn.DataTable.SearchBuilder=x;a.fn.dataTable.Group=v;a.fn.DataTable.Group=v;a.fn.dataTable.Criteria=l;a.fn.DataTable.Criteria=l;b=a.fn.dataTable.Api.register;a.fn.dataTable.ext.searchBuilder={conditions:{}};a.fn.dataTable.ext.buttons.searchBuilder={action:function(a,b,c,d){a.stopPropagation();this.popover(d._searchBuilder.getNode(),{align:"dt-container"})},config:{},init:function(b,c,d){var e=new a.fn.dataTable.SearchBuilder(b,a.extend({filterChanged:function(a,d){b.button(c).text(d)}},d.config));
b.button(c).text(d.text||b.i18n("searchBuilder.button",e.c.i18n.button,0));d._searchBuilder=e},text:null};b("searchBuilder.getDetails()",function(){return this.context[0]._searchBuilder.getDetails()});b("searchBuilder.rebuild()",function(a){this.context[0]._searchBuilder.rebuild(a);return this});b("searchBuilder.container()",function(){return this.context[0]._searchBuilder.getNode()});a(c).on("preInit.dt.dtsp",function(a,b){if("dt"===a.namespace&&(b.oInit.searchBuilder||h.defaults.searchBuilder))b._searchBuilder||
d(b)});h.ext.feature.push({cFeature:"Q",fnInit:d});h.ext.features&&h.ext.features.register("searchBuilder",d)};"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return z(a,window,document)}):"object"===typeof exports?module.exports=function(a,b){a||(a=window);if(!b||!b.fn.dataTable)b=require("datatables.net")(a,b).$;return z(b,a,a.document)}:z(window.jQuery,window,document)})();
