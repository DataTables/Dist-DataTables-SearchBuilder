...
null!==f?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},f):a.c.enterSearch?function(e){13==(e.keyCode||e.which)&&b(a,g)}:function(){b(a,g)}),d("<span>").addClass(a.classes.joiner).text(a.s.dt.i18n("searchBuilder.valueJoiner",a.c.i18n.valueJoiner)),d("<input/>").addClass(c.classes.value).addClass(c.classes.input).dtDateTime({attachTo:"input",format:a.s.dateFormat?a.s.dateFormat:void 0}).on("change",null!==f?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},f):function(){b(a,
g)}).on("input keypress",!a.c.enterSearch&&null!==f?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},f):a.c.enterSearch?function(e){13==(e.keyCode||e.which)&&b(a,g)}:function(){b(a,g)})];a.c.greyscale&&(d(f[0]).addClass(c.classes.greyscale),d(f[2]).addClass(c.classes.greyscale));null!==e&&0<e.length&&(d(f[0]).val(e[0]),d(f[2]).val(e[1]));a.s.dt.one("draw",function(){d(a.s.topGroup).trigger("dtsb-redrawLogic")});return f};c.isInputValidSelect=function(a){for(var b=!0,e=0;e<a.length;e++){var g=
a[e];d(g).children("option:selected").length===d(g).children("option").length-d(g).children("option."+c.classes.notItalic).length&&(1===d(g).children("option:selected").length&&d(g).children("option:selected")[0]===d(g).children("option:hidden")[0])&&(b=!1)}return b};c.isInputValidInput=function(a){for(var b=!0,e=0;e<a.length;e++){var c=a[e];d(c).is("input")&&0===d(c).val().length&&(b=!1)}return b};c.inputValueSelect=function(a){for(var b=[],e=0;e<a.length;e++){var c=a[e];if(d(c).is("select")){var f=
d(c).children("option:selected").val();b.push("Array"===d(c).children("option:selected").attr("type")?f.split(",").sort():f)}}return b};c.inputValueInput=function(a){for(var b=[],e=0;e<a.length;e++){var c=a[e];d(c).is("input")&&b.push(d(c).val())}return b};c.updateListener=function(a,b){var e=a.s.conditions[a.s.condition];a.s.filled=e.isInputValid(a.dom.value,a);a.s.value=e.inputValue(a.dom.value,a);Array.isArray(a.s.value)||(a.s.value=[a.s.value]);for(e=0;e<a.s.value.length;e++)if(Array.isArray(a.s.value[e]))a.s.value[e].sort();
...
if((!0===this.c.columns||Array.isArray(this.c.columns)&&-1!==this.c.columns.indexOf(f))&&(-1!==i.indexOf("date")||-1!==i.indexOf("moment")||-1!==i.indexOf("luxon")))throw alert("SearchBuilder Requires DateTime when used with dates."),Error("SearchBuilder requires DateTime");}}this.s.topGroup=new r(this.s.dt,this.c,void 0);this._setClearListener();this.s.dt.on("stateSaveParams",function(a,c,d){d.searchBuilder=b.getDetails();d.page=b.s.dt.page()});this._build();a&&(a=this.s.dt.state.loaded(),null!==
a&&void 0!==a.searchBuilder?(this.s.topGroup.rebuild(a.searchBuilder),j(this.s.topGroup.dom.container).trigger("dtsb-redrawContents"),this.s.dt.page(a.page).draw("page"),this.s.topGroup.setListeners()):!1!==this.c.preDefined&&(this.c.preDefined=this._applyPreDefDefaults(this.c.preDefined),this.rebuild(this.c.preDefined)));this._setEmptyListener();this.s.dt.state.save()};o.prototype._updateTitle=function(a){j(this.dom.title).text(this.s.dt.i18n("searchBuilder.title",this.c.i18n.title,a))};o.prototype._build=
function(){var a=this;j(this.dom.clearAll).remove();j(this.dom.container).empty();var b=this.s.topGroup.count();this._updateTitle(b);j(this.dom.titleRow).append(this.dom.title);j(this.dom.container).append(this.dom.titleRow);this.dom.topGroup=this.s.topGroup.getNode();j(this.dom.container).append(this.dom.topGroup);this._setRedrawListener();var c=this.s.dt.table(0).node();-1===j.fn.dataTable.ext.search.indexOf(this.s.search)&&(this.s.search=function(b,d,i){return b.nTable!==c?!0:a.s.topGroup.search(d,
i)},j.fn.dataTable.ext.search.push(this.s.search));this.s.dt.on("destroy.dt",function(){j(a.dom.container).remove();j(a.dom.clearAll).remove();for(var b=j.fn.dataTable.ext.search.indexOf(a.s.search);b!==-1;){j.fn.dataTable.ext.search.splice(b,1);b=j.fn.dataTable.ext.search.indexOf(a.s.search)}})};o.prototype._checkClear=function(){0<this.s.topGroup.s.criteria.length?(j(this.dom.clearAll).insertAfter(this.dom.title),this._setClearListener()):j(this.dom.clearAll).remove()};o.prototype._filterChanged=
function(a){var b=this.c.filterChanged;"function"===typeof b&&b(a,this.s.dt.i18n("searchBuilder.button",this.c.i18n.button,a))};o.prototype._setClearListener=function(){var a=this;j(this.dom.clearAll).unbind("click");j(this.dom.clearAll).on("click",function(){a.s.topGroup=new r(a.s.dt,a.c,void 0);a._build();a.s.dt.draw();a.s.topGroup.setListeners();j(a.dom.clearAll).remove();a._setEmptyListener();a._filterChanged(0);return!1})};o.prototype._setRedrawListener=function(){var a=this;j(this.s.topGroup.dom.container).unbind("dtsb-redrawContents");
j(this.s.topGroup.dom.container).on("dtsb-redrawContents",function(){a._checkClear();a.s.topGroup.redrawContents();a.s.topGroup.setupLogic();a._setEmptyListener();var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b);a.s.dt.state.save()});j(this.s.topGroup.dom.container).unbind("dtsb-redrawLogic");j(this.s.topGroup.dom.container).on("dtsb-redrawLogic",function(){a.s.topGroup.redrawLogic();var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b)});j(this.s.topGroup.dom.container).on("dtsb-add",
function(){var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b)});j(this.s.dt).on("postEdit postCreate postRemove",function(){a.s.topGroup.redrawContents()});j(this.s.topGroup.dom.container).unbind("dtsb-clearContents");j(this.s.topGroup.dom.container).on("dtsb-clearContents",function(){a._setUp(!1);a._filterChanged(0);a.s.dt.draw()});j(this.s.topGroup.dom.container).on("dtsb-updateTitle",function(){var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b)})};o.prototype._setEmptyListener=
function(){var a=this;j(this.s.topGroup.dom.add).on("click",function(){a._checkClear()});j(this.s.topGroup.dom.container).on("dtsb-destroy",function(){j(a.dom.clearAll).remove()})};o.version="1.1.0";o.classes={button:"dtsb-button",clearAll:"dtsb-clearAll",container:"dtsb-searchBuilder",inputButton:"dtsb-iptbtn",title:"dtsb-title",titleRow:"dtsb-titleRow"};o.defaults={columns:!0,conditions:{date:l.dateConditions,html:l.stringConditions,"html-num":l.numConditions,"html-num-fmt":l.numFmtConditions,luxon:l.luxonDateConditions,
moment:l.momentDateConditions,num:l.numConditions,"num-fmt":l.numFmtConditions,string:l.stringConditions},depthLimit:!1,enterSearch:!1,filterChanged:void 0,greyscale:!1,i18n:{add:"Add Condition",button:{"0":"Search Builder",_:"Search Builder (%d)"},clearAll:"Clear All",condition:"Condition",conditions:{array:{contains:"Contains",empty:"Empty",equals:"Equals",not:"Not",notEmpty:"Not Empty",without:"Without"},date:{after:"After",before:"Before",between:"Between",empty:"Empty",equals:"Equals",not:"Not",
...
title:{"0":"Custom Search Builder",_:"Custom Search Builder (%d)"},value:"Value",valueJoiner:"and"},logic:"AND",orthogonal:{display:"display",search:"filter"},preDefined:!1};t=o;var u=function(a,b,c){function g(a,b){var c=new f.Api(a),d=b?b:c.init().searchBuilder||f.defaults.searchBuilder;return(new t(c,d)).getNode()}j=a;q=a.fn.DataTable;h=a;s=a.fn.dataTable;d=a;var f=p=a.fn.dataTable;a.fn.dataTable.SearchBuilder=t;a.fn.DataTable.SearchBuilder=t;a.fn.dataTable.Group=r;a.fn.DataTable.Group=r;a.fn.dataTable.Criteria=
l;a.fn.DataTable.Criteria=l;b=a.fn.dataTable.Api.register;a.fn.dataTable.ext.searchBuilder={conditions:{}};a.fn.dataTable.ext.buttons.searchBuilder={action:function(a,b,c,d){a.stopPropagation();this.popover(d._searchBuilder.getNode(),{align:"dt-container"});void 0!==d._searchBuilder.s.topGroup&&d._searchBuilder.s.topGroup.dom.container.trigger("dtsb-redrawContents")},config:{},init:function(b,c,d){var e=new a.fn.dataTable.SearchBuilder(b,a.extend({filterChanged:function(a,d){b.button(c).text(d)}},
d.config));b.button(c).text(d.text||b.i18n("searchBuilder.button",e.c.i18n.button,0));d._searchBuilder=e},text:null};b("searchBuilder.getDetails()",function(){var a=this.context[0];return a._searchBuilder?a._searchBuilder.getDetails():null});b("searchBuilder.rebuild()",function(a){var b=this.context[0];if(void 0===b._searchBuilder)return null;b._searchBuilder.rebuild(a);return this});b("searchBuilder.container()",function(){var a=this.context[0];return a._searchBuilder?a._searchBuilder.getNode():
null});a(c).on("preInit.dt.dtsp",function(a,b){if("dt"===a.namespace&&(b.oInit.searchBuilder||f.defaults.searchBuilder))b._searchBuilder||g(b)});f.ext.feature.push({cFeature:"Q",fnInit:g});f.ext.features&&f.ext.features.register("searchBuilder",g)};"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return u(a,window,document)}):"object"===typeof exports?module.exports=function(a,b){a||(a=window);if(!b||!b.fn.dataTable)b=require("datatables.net")(a,b).$;return u(b,
a,a.document)}:u(window.jQuery,window,document)})();
