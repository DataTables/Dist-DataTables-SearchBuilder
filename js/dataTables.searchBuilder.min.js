...
0;b<a.length;b++)j=a[b],d(this.dom.condition).append(j);d(this.dom.condition).prop("selectedIndex",0)};c.prototype._populateData=function(){var a=this;d(this.dom.data).empty().append(this.dom.dataTitle);if(0===this.s.dataPoints.length)this.s.dt.columns().every(function(b){if(!0===a.c.columns||-1!==a.s.dt.columns(a.c.columns).indexes().toArray().indexOf(b)){for(var e=!1,c=0,h=a.s.dataPoints;c<h.length;c++)if(h[c].index===b){e=!0;break}e||(b={text:a.s.dt.settings()[0].aoColumns[b].sTitle.replace(/(<([^>]+)>)/ig,
""),index:b},a.s.dataPoints.push(b),d(a.dom.data).append(d("<option>",{text:b.text,value:b.index}).addClass(a.classes.option).addClass(a.classes.notItalic)))}});else for(var b=function(b){e.s.dt.columns().every(function(e){a.s.dt.settings()[0].aoColumns[e].sTitle===b.text&&(b.index=e)});var c=d("<option>",{text:b.text.replace(/(<([^>]+)>)/ig,""),value:b.index}).addClass(e.classes.option).addClass(e.classes.notItalic);e.s.data===b.text&&(e.s.dataIdx=b.index,d(c).attr("selected",!0),d(e.dom.data).removeClass(e.classes.italic));
d(e.dom.data).append(c)},e=this,c=0,f=this.s.dataPoints;c<f.length;c++)b(f[c])};c.prototype._populateValue=function(a){var b=this,e=this.s.filled;this.s.filled=!1;setTimeout(function(){d(b.dom.defaultValue).remove()},50);for(var h=function(a){setTimeout(function(){d(a).remove()},50)},f=0,j=this.dom.value;f<j.length;f++)h(j[f]);h=d(this.dom.container).children();if(3<h.length)for(f=2;f<h.length-1;f++)d(h[f]).remove();void 0!==a&&this.s.dt.columns().every(function(e){b.s.dt.settings()[0].aoColumns[e].sTitle===
a.data&&(b.s.dataIdx=e)});this.dom.value=[].concat(this.s.conditions[this.s.condition].init(this,c.updateListener,void 0!==a?a.value:void 0));void 0!==a&&void 0!==a.value&&(this.s.value=a.value);d(this.dom.value[0]).insertAfter(this.dom.condition).trigger("dtsb-inserted");for(f=1;f<this.dom.value.length;f++)d(this.dom.value[f]).insertAfter(this.dom.value[f-1]).trigger("dtsb-inserted");this.s.filled=this.s.conditions[this.s.condition].isInputValid(this.dom.value,this);this.setListeners();e!==this.s.filled&&
(this.s.dt.draw(),this.setListeners())};c.version="1.1.0";c.classes={button:"dtsb-button",buttonContainer:"dtsb-buttonContainer",condition:"dtsb-condition",container:"dtsb-criteria",data:"dtsb-data","delete":"dtsb-delete",dropDown:"dtsb-dropDown",greyscale:"dtsb-greyscale",input:"dtsb-input",italic:"dtsb-italic",joiner:"dtsp-joiner",left:"dtsb-left",notItalic:"dtsb-notItalic",option:"dtsb-option",right:"dtsb-right",select:"dtsb-select",value:"dtsb-value",vertical:"dtsb-vertical"};c.initSelect=function(a,
b,e,h){void 0===e&&(e=null);void 0===h&&(h=!1);var f=d(a.dom.data).children("option:selected").val(),j=a.s.dt.rows().indexes().toArray(),g=a.s.dt.settings()[0],i=d("<select/>").addClass(c.classes.value).addClass(c.classes.dropDown).addClass(c.classes.italic).addClass(c.classes.select).append(a.dom.valueTitle).on("input change",function(){d(this).removeClass(c.classes.italic);b(a,this)});a.c.greyscale&&d(i).addClass(c.classes.greyscale);for(var k=[],l=[],o=0;o<j.length;o++){var n=j[o],m=g.oApi._fnGetCellData(g,
n,f,"string"===typeof a.c.orthogonal?a.c.orthogonal:a.c.orthogonal.search),m="string"===typeof m?m.replace(/[\r\n\u2028]/g," "):m,n=g.oApi._fnGetCellData(g,n,f,"string"===typeof a.c.orthogonal?a.c.orthogonal:a.c.orthogonal.display);"array"===a.s.type&&(m=!Array.isArray(m)?[m]:m=m.sort(),n=!Array.isArray(n)?[n]:n=n.sort());var q=function(b,h){var f=d("<option>",{type:Array.isArray(b)?"Array":"String",value:a.s.type.indexOf("html")!==-1&&b!==null&&typeof b==="string"?b.replace(/(<([^>]+)>)/ig,""):b}).addClass(a.classes.option).addClass(a.classes.notItalic).html(typeof h===
"string"?h.replace(/(<([^>]+)>)/ig,""):h),g=d(f).val();if(k.indexOf(g)===-1){k.push(g);l.push(f);e!==null&&Array.isArray(e[0])&&(e[0]=e[0].sort().join(","));if(e!==null&&f.val()===e[0]){f.attr("selected",true);d(i).removeClass(c.classes.italic)}}};if(h)for(var p=0;p<m.length;p++)q(m[p],n[p]);else q(m,n)}l.sort(function(b,e){if("array"===a.s.type||"string"===a.s.type||"num"===a.s.type||"html"===a.s.type||"html-num"===a.s.type)return d(b).val()<d(e).val()?-1:d(b).val()>d(e).val()?1:0;if("num-fmt"===
a.s.type||"html-num-fmt"===a.s.type)return+d(b).val().replace(/[^0-9.]/g,"")<+d(e).val().replace(/[^0-9.]/g,"")?-1:+d(b).val().replace(/[^0-9.]/g,"")<+d(e).val().replace(/[^0-9.]/g,"")?1:0});for(h=0;h<l.length;h++)f=l[h],d(i).append(f);return i};c.initSelectArray=function(a,b,e){void 0===e&&(e=null);return c.initSelect(a,b,e,!0)};c.initInput=function(a,b,e){var h=this;void 0===e&&(e=null);var f=a.s.dt.settings()[0].searchDelay,f=d("<input/>").addClass(c.classes.value).addClass(c.classes.input).on("input",
null!==f?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},f):function(){b(a,h)});a.c.greyscale&&d(f).addClass(c.classes.greyscale);null!==e&&d(f).val(e[0]);a.s.dt.one("draw",function(){d(a.s.topGroup).trigger("dtsb-redrawLogic")});return f};c.init2Input=function(a,b,e){var h=this;void 0===e&&(e=null);var f=a.s.dt.settings()[0].searchDelay,f=[d("<input/>").addClass(c.classes.value).addClass(c.classes.input).on("input",null!==f?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,
this)},f):function(){b(a,h)}),d("<span>").addClass(a.classes.joiner).text(a.s.dt.i18n("searchBuilder.valueJoiner",a.c.i18n.valueJoiner)),d("<input/>").addClass(c.classes.value).addClass(c.classes.input).on("input",null!==f?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},f):function(){b(a,h)})];a.c.greyscale&&(d(f[0]).addClass(c.classes.greyscale),d(f[2]).addClass(c.classes.greyscale));null!==e&&(d(f[0]).val(e[0]),d(f[2]).val(e[1]));a.s.dt.one("draw",function(){d(a.s.topGroup).trigger("dtsb-redrawLogic")});
return f};c.initDate=function(a,b,e){var h=this;void 0===e&&(e=null);var f=a.s.dt.settings()[0].searchDelay,f=d("<input/>").addClass(c.classes.value).addClass(c.classes.input).dtDateTime({attachTo:"input",format:a.s.dateFormat?a.s.dateFormat:void 0}).on("input change",null!==f?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},f):function(){b(a,h)});a.c.greyscale&&d(f).addClass(c.classes.greyscale);null!==e&&d(f).val(e[0]);a.s.dt.one("draw",function(){d(a.s.topGroup).trigger("dtsb-redrawLogic")});
return f};c.initNoValue=function(a){a.s.dt.one("draw",function(){d(a.s.topGroup).trigger("dtsb-redrawLogic")})};c.init2Date=function(a,b,e){var h=this;void 0===e&&(e=null);var f=a.s.dt.settings()[0].searchDelay,f=[d("<input/>").addClass(c.classes.value).addClass(c.classes.input).dtDateTime({attachTo:"input",format:a.s.dateFormat?a.s.dateFormat:void 0}).on("input change",null!==f?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},f):function(){b(a,h)}),d("<span>").addClass(a.classes.joiner).text(a.s.dt.i18n("searchBuilder.valueJoiner",
a.c.i18n.valueJoiner)),d("<input/>").addClass(c.classes.value).addClass(c.classes.input).dtDateTime({attachTo:"input",format:a.s.dateFormat?a.s.dateFormat:void 0}).on("input change",null!==f?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},f):function(){b(a,h)})];a.c.greyscale&&(d(f[0]).addClass(c.classes.greyscale),d(f[2]).addClass(c.classes.greyscale));null!==e&&0<e.length&&(d(f[0]).val(e[0]),d(f[2]).val(e[1]));a.s.dt.one("draw",function(){d(a.s.topGroup).trigger("dtsb-redrawLogic")});
return f};c.isInputValidSelect=function(a){for(var b=!0,e=0;e<a.length;e++){var h=a[e];d(h).children("option:selected").length===d(h).children("option").length-d(h).children("option."+c.classes.notItalic).length&&(1===d(h).children("option:selected").length&&d(h).children("option:selected")[0]===d(h).children("option:hidden")[0])&&(b=!1)}return b};c.isInputValidInput=function(a){for(var b=!0,e=0;e<a.length;e++){var c=a[e];d(c).is("input")&&0===d(c).val().length&&(b=!1)}return b};c.inputValueSelect=
function(a){for(var b=[],e=0;e<a.length;e++){var c=a[e];if(d(c).is("select")){var f=d(c).children("option:selected").val();b.push("Array"===d(c).children("option:selected").attr("type")?f.split(",").sort():f)}}return b};c.inputValueInput=function(a){for(var b=[],e=0;e<a.length;e++){var c=a[e];d(c).is("input")&&b.push(d(c).val())}return b};c.updateListener=function(a,b){var e=a.s.conditions[a.s.condition];a.s.filled=e.isInputValid(a.dom.value,a);a.s.value=e.inputValue(a.dom.value,a);Array.isArray(a.s.value)||
(a.s.value=[a.s.value]);for(e=0;e<a.s.value.length;e++)if(Array.isArray(a.s.value[e]))a.s.value[e].sort();else if(-1!==a.s.type.indexOf("num")&&(""!==a.s.dt.settings()[0].oLanguage.sDecimal||""!==a.s.dt.settings()[0].oLanguage.sThousands)){var c=[a.s.value[e].toString()];""!==a.s.dt.settings()[0].oLanguage.sDecimal&&(c=a.s.value[e].split(a.s.dt.settings()[0].oLanguage.sDecimal));if(""!==a.s.dt.settings()[0].oLanguage.sThousands)for(var f=0;f<c.length;f++)c[f]=c[f].replace(a.s.dt.settings()[0].oLanguage.sThousands,
",");a.s.value[e]=c.join(".")}f=c=null;for(e=0;e<a.dom.value.length;e++)b===a.dom.value[e][0]&&(c=e,void 0!==b.selectionStart&&(f=b.selectionStart));a.s.dt.draw();null!==c&&(d(a.dom.value[c]).removeClass(a.classes.italic),d(a.dom.value[c]).focus(),null!==f&&d(a.dom.value[c])[0].setSelectionRange(f,f))};c.dateConditions={"=":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.equals",b.conditions.date.equals)},init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,
...
inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,e){return m.DateTime.fromFormat(a,e.s.dateFormat).ts<m.DateTime.fromFormat(b[0],e.s.dateFormat).ts}},">":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.after",b.conditions.date.after)},init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,e){return m.DateTime.fromFormat(a,e.s.dateFormat).ts>m.DateTime.fromFormat(b[0],e.s.dateFormat).ts}},between:{conditionName:function(a,
...
inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,e){var a=m.DateTime.fromFormat(a,e.s.dateFormat).ts,c=m.DateTime.fromFormat(b[0],e.s.dateFormat).ts,b=m.DateTime.fromFormat(b[1],e.s.dateFormat).ts;return c<b?!(+c<=+a&&+a<=+b):!(+b<=+a&&+a<=+c)}},"null":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.empty",b.conditions.date.empty)},isInputValid:function(){return!0},init:c.initNoValue,inputValue:function(){},search:function(a){return null===
...
b.conditions.number.notEmpty)},isInputValid:function(){return!0},init:c.initNoValue,inputValue:function(){},search:function(a){return!(null===a||void 0===a||0===a.length)}}};c.numFmtConditions={"=":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.number.equals",b.conditions.number.equals)},init:c.initSelect,inputValue:c.inputValueSelect,isInputValid:c.isInputValidSelect,search:function(a,b){var c=0===a.indexOf("-")?"-"+a.replace(/[^0-9.]/g,""):a.replace(/[^0-9.]/g,""),d=0===b[0].indexOf("-")?
"-"+b[0].replace(/[^0-9.]/g,""):b[0].replace(/[^0-9.]/g,"");return+c===+d}},"!=":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.number.not",b.conditions.number.not)},init:c.initSelect,inputValue:c.inputValueSelect,isInputValid:c.isInputValidSelect,search:function(a,b){var c=0===a.indexOf("-")?"-"+a.replace(/[^0-9.]/g,""):a.replace(/[^0-9.]/g,""),d=0===b[0].indexOf("-")?"-"+b[0].replace(/[^0-9.]/g,""):b[0].replace(/[^0-9.]/g,"");return+c!==+d}},"<":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.number.lt",
...
b){var c=0===a.indexOf("-")?"-"+a.replace(/[^0-9.]/g,""):a.replace(/[^0-9.]/g,""),d=0===b[0].indexOf("-")?"-"+b[0].replace(/[^0-9.]/g,""):b[0].replace(/[^0-9.]/g,"");return+c<=+d}},">=":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.number.gte",b.conditions.number.gte)},init:c.initInput,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){var c=0===a.indexOf("-")?"-"+a.replace(/[^0-9.]/g,""):a.replace(/[^0-9.]/g,""),d=0===b[0].indexOf("-")?"-"+b[0].replace(/[^0-9.]/g,
""):b[0].replace(/[^0-9.]/g,"");return+c>=+d}},">":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.number.gt",b.conditions.number.gt)},init:c.initInput,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){var c=0===a.indexOf("-")?"-"+a.replace(/[^0-9.]/g,""):a.replace(/[^0-9.]/g,""),d=0===b[0].indexOf("-")?"-"+b[0].replace(/[^0-9.]/g,""):b[0].replace(/[^0-9.]/g,"");return+c>+d}},between:{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.number.between",
b.conditions.number.between)},init:c.init2Input,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){var c=0===a.indexOf("-")?"-"+a.replace(/[^0-9.]/g,""):a.replace(/[^0-9.]/g,""),d=0===b[0].indexOf("-")?"-"+b[0].replace(/[^0-9.]/g,""):b[0].replace(/[^0-9.]/g,""),f=0===b[1].indexOf("-")?"-"+b[1].replace(/[^0-9.]/g,""):b[1].replace(/[^0-9.]/g,"");return+d<+f?+d<=+c&&+c<=+f:+f<=+c&&+c<=+d}},"!between":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.number.notBetween",
b.conditions.number.notBetween)},init:c.init2Input,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){var c=0===a.indexOf("-")?"-"+a.replace(/[^0-9.]/g,""):a.replace(/[^0-9.]/g,""),d=0===b[0].indexOf("-")?"-"+b[0].replace(/[^0-9.]/g,""):b[0].replace(/[^0-9.]/g,""),f=0===b[1].indexOf("-")?"-"+b[1].replace(/[^0-9.]/g,""):b[1].replace(/[^0-9.]/g,"");return+d<+f?!(+d<=+c&&+c<=+f):!(+f<=+c&&+c<=+d)}},"null":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.number.empty",
...
g(this.dom.add).on("click",function(){a.s.isChild||g(a.dom.container).prepend(a.dom.logicContainer);a.addCriteria();g(a.dom.container).trigger("dtsb-add");a.s.dt.state.save();return!1});for(var b=0,c=this.s.criteria;b<c.length;b++)c[b].criteria.setListeners();this._setClearListener();this._setLogicListener()};k.prototype.addCriteria=function(a,b){void 0===a&&(a=null);void 0===b&&(b=!0);var c=null===a?this.s.criteria.length:a.s.index,d=new l(this.s.dt,this.s.opts,this.s.topGroup,c,this.s.depth);null!==
a&&(d.c=a.c,d.s=a.s,d.s.depth=this.s.depth,d.classes=a.classes);d.populate();for(var f=!1,j=0;j<this.s.criteria.length;j++)0===j&&this.s.criteria[j].criteria.s.index>d.s.index?(g(d.getNode()).insertBefore(this.s.criteria[j].criteria.dom.container),f=!0):j<this.s.criteria.length-1&&(this.s.criteria[j].criteria.s.index<d.s.index&&this.s.criteria[j+1].criteria.s.index>d.s.index)&&(g(d.getNode()).insertAfter(this.s.criteria[j].criteria.dom.container),f=!0);f||g(d.getNode()).insertBefore(this.dom.add);
this.s.criteria.push({criteria:d,index:c});this.s.criteria=this.s.criteria.sort(function(a,b){return a.criteria.s.index-b.criteria.s.index});c=0;for(f=this.s.criteria;c<f.length;c++)j=f[c],j.criteria instanceof l&&j.criteria.updateArrows(1<this.s.criteria.length,b);this._setCriteriaListeners(d);d.setListeners();this.setupLogic()};k.prototype.checkFilled=function(){for(var a=0,b=this.s.criteria;a<b.length;a++){var c=b[a];if(c.criteria instanceof l&&c.criteria.s.filled||c.criteria instanceof k&&c.criteria.checkFilled())return!0}return!1};
