...
e.inputValue(a.dom.value,a);for(var g=e=null,l=0;l<a.dom.value.length;l++)b===a.dom.value[l][0]&&(e=l,void 0!==b.selectionStart&&(g=b.selectionStart));a.s.dt.draw();null!==e&&(f(a.dom.value[e]).removeClass(a.classes.italic),f(a.dom.value[e]).focus(),null!==g&&f(a.dom.value[e])[0].setSelectionRange(g,g))};c.dateConditions={"!=":{conditionName:"Not",init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){a=a.replace(/(\/|\-|,)/g,"-");return a!==b[0]}},"!between":{conditionName:"Not Between",
init:c.init2Date,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){a=a.replace(/(\/|\-|,)/g,"-");return b[0]<b[1]?!(b[0]<=a&&a<=b[1]):!(b[1]<=a&&a<=b[0])}},"!null":{conditionName:"Not Empty",isInputValid:function(){return!0},init:function(){},inputValue:function(){},search:function(a,b){return!(null===a||void 0===a||0===a.length)}},"<":{conditionName:"Before",init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){a=a.replace(/(\/|\-|,)/g,
"-");return a<b[0]}},"=":{conditionName:"Equals",init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){a=a.replace(/(\/|\-|,)/g,"-");return a===b[0]}},">":{conditionName:"After",init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){a=a.replace(/(\/|\-|,)/g,"-");return a>b[0]}},between:{conditionName:"Between",init:c.init2Date,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){a=
a.replace(/(\/|\-|,)/g,"-");return b[0]<b[1]?b[0]<=a&&a<=b[1]:b[1]<=a&&a<=b[0]}},"null":{conditionName:"Empty",isInputValid:function(){return!0},init:function(){},inputValue:function(){},search:function(a,b){return null===a||void 0===a||0===a.length}}};c.momentDateConditions={"!=":{conditionName:"Not",init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,e){return y(a,e.s.momentFormat).valueOf()!==y(b[0],e.s.momentFormat).valueOf()}},"!between":{conditionName:"Not Between",
...
this.s.logic?this._andSearch(a):"OR"===this.s.logic?this._orSearch(a):!0};c.prototype.setupLogic=function(){q(this.dom.logicContainer).remove();q(this.dom.clear).remove();if(1>this.s.criteria.length)this.s.isChild||(q(this.dom.container).trigger("dtsb-destroy"),q(this.dom.container).css("margin-left",10));else{var a=q(this.dom.container).height()-2;q(this.dom.clear).height("0px");q(this.dom.logicContainer).append(this.dom.clear).width(a);q(this.dom.container).prepend(this.dom.logicContainer);this._setLogicListener();
...
{0:"Search Builder",_:"Search Builder (%d)"},a))};c.prototype._build=function(){var a=this;n(this.dom.container).empty();var b=this.s.topGroup.count();this._updateTitle(b);n(this.dom.titleRow).append(this.dom.title);n(this.dom.container).append(this.dom.titleRow);this.dom.topGroup=this.s.topGroup.getNode();n(this.dom.container).append(this.dom.topGroup);this._setRedrawListener();var e=this.s.dt.table(0).node();-1===n.fn.dataTable.ext.search.indexOf(this.s.search)&&(this.s.search=function(g,l,d,h){return g.nTable!==
e?!0:a.s.topGroup.search(l)},n.fn.dataTable.ext.search.push(this.s.search));n.fn.DataTable.Api.registerPlural("columns().type()","column().type()",function(g,l){return this.iterator("column",function(d,h){return d.aoColumns[h].sType},1)});this.s.dt.on("destroy.dt",function(){n(a.dom.container).remove();n(a.dom.clearAll).remove();for(var g=n.fn.dataTable.ext.search.indexOf(a.s.search);-1!==g;)n.fn.dataTable.ext.search.splice(g,1),g=n.fn.dataTable.ext.search.indexOf(a.s.search)})};c.prototype._checkClear=
function(){0<this.s.topGroup.s.criteria.length?(n(this.dom.clearAll).insertAfter(this.dom.title),this._setClearListener()):n(this.dom.clearAll).remove()};c.prototype._setClearListener=function(){var a=this;n(this.dom.clearAll).unbind("click");n(this.dom.clearAll).on("click",function(){a.s.topGroup=new t(a.s.dt,a.s.opts,void 0);a._build();a.s.dt.draw();a.s.topGroup.setListeners();n(a.dom.clearAll).remove();a._setEmptyListener();void 0!==a.c.filterChanged&&"function"===typeof a.c.filterChanged&&a.c.filterChanged(0);
