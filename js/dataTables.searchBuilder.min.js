...
i&&(i.setUTCHours(0),i.setUTCMinutes(0),i.setSeconds(0));h&&(h.setUTCHours(23),h.setUTCMinutes(59),h.setSeconds(59));for(var l=0,j=0;l<n;l++){var k=new Date(Date.UTC(b,d,1+(l-c))),o=this.s.d?this._compareDates(k,this.s.d):!1,A=this._compareDates(k,f),r=l<c||l>=e+c,x=i&&k<i||h&&k>h,u=this.c.disableDays;a.isArray(u)&&-1!==a.inArray(k.getUTCDay(),u)?x=!0:"function"===typeof u&&!0===u(k)&&(x=!0);g.push(this._htmlDay({day:1+(l-c),month:d,year:b,selected:o,today:A,disabled:x,empty:r}));7===++j&&(this.c.showWeekNumber&&
g.unshift(this._htmlWeekOfYear(l-c,d,b)),m.push("<tr>"+g.join("")+"</tr>"),g=[],j=0)}f=this.c.classPrefix;e=f+"-table";this.c.showWeekNumber&&(e+=" weekNumber");i&&(i=i>=new Date(Date.UTC(b,d,1,0,0,0)),this.dom.title.find("div."+f+"-iconLeft").css("display",i?"none":"block"));h&&(h=h<new Date(Date.UTC(b,d+1,1,0,0,0)),this.dom.title.find("div."+f+"-iconRight").css("display",h?"none":"block"));return'<table class="'+e+'"><thead>'+this._htmlMonthHead()+"</thead><tbody>"+m.join("")+"</tbody></table>"},
...
l=this.c.i18n;if(g.length){var j="";n=10;var k=function(c,g,n){12===d&&(12<=f&&"number"===typeof c)&&(c+=12);var h=f===c||"am"===c&&12>f||"pm"===c&&12<=f?"selected":"";e&&-1===a.inArray(c,e)&&(h+=" disabled");n&&(h+=" "+n);return'<td class="selectable '+h+'"><button class="'+m+"-button "+m+'-day" type="button" data-unit="'+b+'" data-value="'+c+'"><span>'+g+"</span></button></td>"};if(12===d){j+="<tr>";for(c=1;6>=c;c++)j+=k(c,h(c));j+=k("am",l.amPm[0]);j+="</tr><tr>";for(c=7;12>=c;c++)j+=k(c,h(c));
j+=k("pm",l.amPm[1]);j+="</tr>";n=7}else{if(24===d){var o=0;for(n=0;4>n;n++){j+="<tr>";for(c=0;6>c;c++)j+=k(o,h(o)),o++;j+="</tr>"}}else{j+="<tr>";for(n=0;60>n;n+=10)j+=k(n,h(n),"range");c=null!==c?c:10*Math.floor(f/10);j=j+"</tr>"+('</tbody></thead><table class="'+i+" "+i+'-nospace"><tbody>')+"<tr>";for(n=c+1;n<c+10;n++)j+=k(n,h(n));j+="</tr>"}n=6}g.empty().append('<table class="'+i+'"><thead><tr><th colspan="'+n+'">'+l[b]+"</th></tr></thead><tbody>"+j+"</tbody></table>")}},_optionsTitle:function(){var a=
...
d){return k(a,d.s.momentFormat).valueOf()!==k(b[0],d.s.momentFormat).valueOf()}},"!between":{conditionName:"Not Between",init:c.init2Date,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,d){var a=k(a,d.s.momentFormat).valueOf(),c=k(b[0],d.s.momentFormat).valueOf(),b=k(b[1],d.s.momentFormat).valueOf();return c<b?!(+c<=+a&&+a<=+b):!(+b<=+a&&+a<=+c)}},"!null":{conditionName:"Not Empty",isInputValid:function(){return!0},init:function(){},inputValue:function(){},search:function(a){return!(null===
a||void 0===a||0===a.length)}},"<":{conditionName:"Before",init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,d){return k(a,d.s.momentFormat).valueOf()<k(b[0],d.s.momentFormat).valueOf()}},"=":{conditionName:"Equals",init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,d){return k(a,d.s.momentFormat).valueOf()===k(b[0],d.s.momentFormat).valueOf()}},">":{conditionName:"After",init:c.initDate,inputValue:c.inputValueInput,
isInputValid:c.isInputValidInput,search:function(a,b,d){return k(a,d.s.momentFormat).valueOf()>k(b[0],d.s.momentFormat).valueOf()}},between:{conditionName:"Between",init:c.init2Date,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,d){var a=k(a,d.s.momentFormat).valueOf(),c=k(b[0],d.s.momentFormat).valueOf(),b=k(b[1],d.s.momentFormat).valueOf();return c<b?c<=a&&a<=b:b<=a&&a<=c}},"null":{conditionName:"Empty",isInputValid:function(){return!0},init:function(){},inputValue:function(){},
...
c.defaults={columns:!0,conditions:{date:c.dateConditions,html:c.stringConditions,"html-num":c.numConditions,"html-num-fmt":c.numFmtConditions,moment:c.momentDateConditions,num:c.numConditions,"num-fmt":c.numFmtConditions,string:c.stringConditions},depthLimit:!1,greyscale:!1,orthogonal:{conditionName:"Condition Name",search:"filter"}};o=c;var g,v,s,i=function(a,b,d,c,e,h){void 0===c&&(c=0);void 0===e&&(e=!1);void 0===h&&(h=1);if(!v||!v.versionCheck||!v.versionCheck("1.10.0"))throw Error("SearchBuilder requires DataTables 1.10 or newer");
...
void 0===this.s.topGroup&&(this.s.topGroup=this.dom.container);this._setup();return this};i.prototype.destroy=function(){g(this.dom.add).off(".dtsb");g(this.dom.logic).off(".dtsb");g(this.dom.container).trigger("dtsb-destroy").remove();this.s.criteria=[]};i.prototype.getDetails=function(){if(0===this.s.criteria.length)return{};for(var a={criteria:[],logic:this.s.logic},b=0,d=this.s.criteria;b<d.length;b++)a.criteria.push(d[b].criteria.getDetails());return a};i.prototype.getNode=function(){return this.dom.container};
i.prototype.rebuild=function(a){if(!(void 0===a.criteria||null===a.criteria||0===a.criteria.length)){this.s.logic=a.logic;g(this.dom.logic).text("OR"===this.s.logic?this.s.dt.i18n("searchBuilder.logicOr",this.c.i18n.logicOr):this.s.dt.i18n("searchBuilder.logicAnd",this.c.i18n.logicAnd));for(var b=0,d=a.criteria;b<d.length;b++)a=d[b],void 0!==a.logic?this._addPrevGroup(a):void 0===a.logic&&this._addPrevCriteria(a);b=0;for(d=this.s.criteria;b<d.length;b++)a=d[b],void 0===a.logic&&(a.criteria.updateArrows(1<
this.s.criteria.length,!1),this._setCriteriaListeners(a.criteria))}};i.prototype.redrawContents=function(){g(this.dom.container).empty().append(this.dom.logicContainer).append(this.dom.add);this.s.criteria.sort(function(a,d){return a.criteria.s.index<d.criteria.s.index?-1:a.criteria.s.index>d.criteria.s.index?1:0});this.setListeners();for(var a=0;a<this.s.criteria.length;a++)void 0===this.s.criteria[a].logic?(this.s.criteria[a].index=a,this.s.criteria[a].criteria.s.index=a,g(this.s.criteria[a].criteria.dom.container).insertBefore(this.dom.add),
this._setCriteriaListeners(this.s.criteria[a].criteria),this.s.criteria[a].criteria.rebuild(this.s.criteria[a].criteria.getDetails())):0<this.s.criteria[a].criteria.s.criteria.length?(this.s.criteria[a].index=a,this.s.criteria[a].criteria.s.index=a,g(this.s.criteria[a].criteria.dom.container).insertBefore(this.dom.add),this.s.criteria[a].criteria.redrawContents(),this._setGroupListeners(this.s.criteria[a].criteria)):(this.s.criteria.splice(a,1),a--);this.setupLogic()};i.prototype.search=function(a){return"AND"===
this.s.logic?this._andSearch(a):"OR"===this.s.logic?this._orSearch(a):!0};i.prototype.setupLogic=function(){g(this.dom.logicContainer).remove();g(this.dom.clear).remove();if(1>this.s.criteria.length)this.s.isChild||(g(this.dom.container).trigger("dtsb-destroy"),g(this.dom.container).css("margin-left",0));else{var a=g(this.dom.container).height()-2;g(this.dom.clear).height("0px");g(this.dom.logicContainer).append(this.dom.clear).width(a);g(this.dom.container).prepend(this.dom.logicContainer);this._setLogicListener();
g(this.dom.container).css("margin-left",g(this.dom.logicContainer).outerHeight(!0));var a=g(this.dom.logicContainer).offset(),b=a.left,d=g(this.dom.container).offset().left,b=b-(b-d)-g(this.dom.logicContainer).outerHeight(!0);g(this.dom.logicContainer).offset({left:b});b=g(this.dom.logicContainer).next();a=a.top;b=g(b).offset().top;a-=a-b;g(this.dom.logicContainer).offset({top:a});g(this.dom.clear).outerHeight(g(this.dom.logicContainer).height());this._setClearListener()}};i.prototype.setListeners=
function(){var a=this;g(this.dom.add).unbind("click");g(this.dom.add).on("click",function(){a.s.isChild||g(a.dom.container).prepend(a.dom.logicContainer);a.addCriteria();g(a.dom.container).trigger("dtsb-add");a.s.dt.state.save();return!1});for(var b=0,d=this.s.criteria;b<d.length;b++)d[b].criteria.setListeners();this._setClearListener();this._setLogicListener()};i.prototype.addCriteria=function(a,b){void 0===a&&(a=null);void 0===b&&(b=!0);var d=null===a?this.s.criteria.length:a.s.index,c=new o(this.s.dt,
...
e=!0);e||g(c.getNode()).insertBefore(this.dom.add);this.s.criteria.push({criteria:c,index:d});this.s.criteria=this.s.criteria.sort(function(a,b){return a.criteria.s.index-b.criteria.s.index});d=0;for(e=this.s.criteria;d<e.length;d++)h=e[d],void 0===h.logic&&h.criteria.updateArrows(1<this.s.criteria.length,b);this._setCriteriaListeners(c);c.setListeners();this.setupLogic()};i.prototype.checkFilled=function(){for(var a=0,b=this.s.criteria;a<b.length;a++){var d=b[a];if(void 0===d.logic&&d.criteria.s.filled||
...
g(b.dom.container).trigger("dtsb-dropCriteria");a.s.index=c;b._removeCriteria(a);g(b.s.topGroup).trigger("dtsb-redrawContents");b.s.dt.draw();return!1})};i.prototype._setClearListener=function(){var a=this;g(this.dom.clear).unbind("click").on("click",function(){if(!a.s.isChild)return g(a.dom.container).trigger("dtsb-clearContents"),!1;a.destroy();g(a.s.topGroup).trigger("dtsb-updateTitle");g(a.s.topGroup).trigger("dtsb-redrawContents");return!1})};i.prototype._setGroupListeners=function(a){var b=
...
this.c.i18n.logicAnd))):"AND"===this.s.logic&&(this.s.logic="OR",g(this.dom.logic).text(this.s.dt.i18n("searchBuilder.logicOr",this.c.i18n.logicOr)))};i.version="0.0.1";i.classes={add:"dtsb-add",button:"dtsb-button",clearGroup:"dtsb-clearGroup",greyscale:"dtsb-greyscale",group:"dtsb-group",inputButton:"dtsb-iptbtn",logic:"dtsb-logic",logicContainer:"dtsb-logicContainer"};i.defaults={depthLimit:!1,greyscale:!1,logic:"AND"};s=i;var h,t,w,l=function(a,b){var c=this;if(!t||!t.versionCheck||!t.versionCheck("1.10.0"))throw Error("SearchBuilder requires DataTables 1.10 or newer");
...
h(this.s.topGroup.dom.container).on("dtsb-clearContents",function(){a._setUp(!1);a._filterChanged(0);a.s.dt.draw()});h(this.s.topGroup.dom.container).on("dtsb-updateTitle",function(){var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b)})};l.prototype._setEmptyListener=function(){var a=this;h(this.s.topGroup.dom.add).on("click",function(){a._checkClear()});h(this.s.topGroup.dom.container).on("dtsb-destroy",function(){h(a.dom.clearAll).remove()})};l.version="0.0.1";l.classes={button:"dtsb-button",
clearAll:"dtsb-clearAll",container:"dtsb-searchBuilder",inputButton:"dtsb-iptbtn",title:"dtsb-title",titleRow:"dtsb-titleRow"};l.defaults={filterChanged:void 0,preDefined:!1,i18n:{add:"Add Condition",button:{"0":"Search Builder",_:"Search Builder (%d)"},clearAll:"Clear All",condition:"Condition",data:"Data",deleteTitle:"Delete filtering rule",logicAnd:"And",logicOr:"Or",leftTitle:"Outdent criteria",rightTitle:"Indent criteria",title:{"0":"Custom Search Builder",_:"Custom Search Builder (%d)"},value:"Value"}};
w=l;var z=function(a,b,c){function f(a,b){var c=new i.Api(a),d=b?b:c.init().searchBuilder||i.defaults.searchBuilder;return(new w(c,d)).getNode()}h=a;t=a.fn.DataTable;g=a;v=a.fn.dataTable;e=a;var i=r=a.fn.dataTable;a.fn.dataTable.SearchBuilder=w;a.fn.DataTable.SearchBuilder=w;a.fn.dataTable.Group=s;a.fn.DataTable.Group=s;a.fn.dataTable.Criteria=o;a.fn.DataTable.Criteria=o;b=a.fn.dataTable.Api.register;a.fn.dataTable.ext.searchBuilder={conditions:{}};a.fn.dataTable.ext.buttons.searchBuilder={action:function(a,
...
return this});b("searchBuilder.container()",function(){return this.context[0]._searchBuilder.getNode()});a(c).on("preInit.dt.dtsp",function(a,b){if("dt"===a.namespace&&(b.oInit.searchBuilder||i.defaults.searchBuilder))b._searchBuilder||f(b)});i.ext.feature.push({cFeature:"Q",fnInit:f});i.ext.features&&i.ext.features.register("searchBuilder",f)};"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return z(a,window,document)}):"object"===typeof exports?module.exports=
