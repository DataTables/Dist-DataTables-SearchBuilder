...
c.defaults={columns:!0,conditions:{date:c.dateConditions,html:c.stringConditions,"html-num":c.numConditions,"html-num-fmt":c.numFmtConditions,moment:c.momentDateConditions,num:c.numConditions,"num-fmt":c.numFmtConditions,string:c.stringConditions},depthLimit:!1,filterChanged:void 0,greyscale:!1,i18n:void 0,logic:"AND",orthogonal:{conditionName:"Condition Name",search:"filter"},preDefined:!1};j=c;var g,w,t,i=function(a,b,d,c,e,h){void 0===c&&(c=0);void 0===e&&(e=!1);void 0===h&&(h=1);if(!w||!w.versionCheck||
!w.versionCheck("1.10.0"))throw Error("SearchBuilder requires DataTables 1.10 or newer");this.classes=g.extend(!0,{},i.classes);this.c=g.extend(!0,{},i.defaults,b);this.s={criteria:[],depth:h,dt:a,index:c,isChild:e,logic:void 0,opts:b,toDrop:void 0,topGroup:d};this.dom={add:g("<button/>").addClass(this.classes.add).addClass(this.classes.button),clear:g("<button>&times</button>").addClass(this.classes.button).addClass(this.classes.clearGroup),container:g("<div/>").addClass(this.classes.group),logic:g("<button/>").addClass(this.classes.logic).addClass(this.classes.button),
logicContainer:g("<div/>").addClass(this.classes.logicContainer)};void 0===this.s.topGroup&&(this.s.topGroup=this.dom.container);this._setup();return this};i.prototype.destroy=function(){g(this.dom.add).off(".dtsb");g(this.dom.logic).off(".dtsb");g(this.dom.container).trigger("dtsb-destroy").remove();this.s.criteria=[]};i.prototype.getDetails=function(){if(0===this.s.criteria.length)return{};for(var a={criteria:[],logic:this.s.logic},b=0,d=this.s.criteria;b<d.length;b++)a.criteria.push(d[b].criteria.getDetails());
return a};i.prototype.getNode=function(){return this.dom.container};i.prototype.rebuild=function(a){if(!(void 0===a.criteria||null===a.criteria||0===a.criteria.length)){this.s.logic=a.logic;g(this.dom.logic).text("OR"===this.s.logic?this.s.dt.i18n("searchBuilder.logicOr",this.c.i18n.logicOr):this.s.dt.i18n("searchBuilder.logicAnd",this.c.i18n.logicAnd));for(var b=0,d=a.criteria;b<d.length;b++)a=d[b],void 0!==a.logic?this._addPrevGroup(a):void 0===a.logic&&this._addPrevCriteria(a);b=0;for(d=this.s.criteria;b<
d.length;b++)a=d[b],a.criteria instanceof j&&(a.criteria.updateArrows(1<this.s.criteria.length,!1),this._setCriteriaListeners(a.criteria))}};i.prototype.redrawContents=function(){g(this.dom.container).empty().append(this.dom.logicContainer).append(this.dom.add);this.s.criteria.sort(function(a,b){return a.criteria.s.index<b.criteria.s.index?-1:a.criteria.s.index>b.criteria.s.index?1:0});this.setListeners();for(var a=0;a<this.s.criteria.length;a++){var b=this.s.criteria[a].criteria;b instanceof j?(this.s.criteria[a].index=
...
function(a){return"AND"===this.s.logic?this._andSearch(a):"OR"===this.s.logic?this._orSearch(a):!0};i.prototype.setupLogic=function(){g(this.dom.logicContainer).remove();g(this.dom.clear).remove();if(1>this.s.criteria.length)this.s.isChild||(g(this.dom.container).trigger("dtsb-destroy"),g(this.dom.container).css("margin-left",0));else{var a=g(this.dom.container).height()-2;g(this.dom.clear).height("0px");g(this.dom.logicContainer).append(this.dom.clear).width(a);g(this.dom.container).prepend(this.dom.logicContainer);
this._setLogicListener();g(this.dom.container).css("margin-left",g(this.dom.logicContainer).outerHeight(!0));var a=g(this.dom.logicContainer).offset(),b=a.left,d=g(this.dom.container).offset().left,b=b-(b-d)-g(this.dom.logicContainer).outerHeight(!0);g(this.dom.logicContainer).offset({left:b});b=g(this.dom.logicContainer).next();a=a.top;b=g(b).offset().top;a-=a-b;g(this.dom.logicContainer).offset({top:a});g(this.dom.clear).outerHeight(g(this.dom.logicContainer).height());this._setClearListener()}};
i.prototype.setListeners=function(){var a=this;g(this.dom.add).unbind("click");g(this.dom.add).on("click",function(){a.s.isChild||g(a.dom.container).prepend(a.dom.logicContainer);a.addCriteria();g(a.dom.container).trigger("dtsb-add");a.s.dt.state.save();return!1});for(var b=0,d=this.s.criteria;b<d.length;b++)d[b].criteria.setListeners();this._setClearListener();this._setLogicListener()};i.prototype.addCriteria=function(a,b){void 0===a&&(a=null);void 0===b&&(b=!0);var d=null===a?this.s.criteria.length:
a.s.index,c=new j(this.s.dt,this.s.opts,this.s.topGroup,d,this.s.depth);null!==a&&(c.c=a.c,c.s=a.s,c.s.depth=this.s.depth,c.classes=a.classes);c.populate();for(var e=!1,h=0;h<this.s.criteria.length;h++)0===h&&this.s.criteria[h].criteria.s.index>c.s.index?(g(c.getNode()).insertBefore(this.s.criteria[h].criteria.dom.container),e=!0):h<this.s.criteria.length-1&&(this.s.criteria[h].criteria.s.index<c.s.index&&this.s.criteria[h+1].criteria.s.index>c.s.index)&&(g(c.getNode()).insertAfter(this.s.criteria[h].criteria.dom.container),
e=!0);e||g(c.getNode()).insertBefore(this.dom.add);this.s.criteria.push({criteria:c,index:d});this.s.criteria=this.s.criteria.sort(function(a,b){return a.criteria.s.index-b.criteria.s.index});d=0;for(e=this.s.criteria;d<e.length;d++)h=e[d],h.criteria instanceof j&&h.criteria.updateArrows(1<this.s.criteria.length,b);this._setCriteriaListeners(c);c.setListeners();this.setupLogic()};i.prototype.checkFilled=function(){for(var a=0,b=this.s.criteria;a<b.length;a++){var d=b[a];if(d.criteria instanceof j&&
d.criteria.s.filled||d.criteria instanceof i&&d.criteria.checkFilled())return!0}return!1};i.prototype.count=function(){for(var a=0,b=0,d=this.s.criteria;b<d.length;b++){var c=d[b];c.criteria instanceof i?a+=c.criteria.count():a++}return a};i.prototype._addPrevGroup=function(a){var b=this.s.criteria.length,d=new i(this.s.dt,this.c,this.s.topGroup,b,!0,this.s.depth+1);this.s.criteria.push({criteria:d,index:b,logic:d.s.logic});d.rebuild(a);this.s.criteria[b].criteria=d;g(this.s.topGroup).trigger("dtsb-redrawContents");
this._setGroupListeners(d)};i.prototype._addPrevCriteria=function(a){var b=this.s.criteria.length,d=new j(this.s.dt,this.s.opts,this.s.topGroup,b,this.s.depth);d.populate();this.s.criteria.push({criteria:d,index:b});d.rebuild(a);this.s.criteria[b].criteria=d;g(this.s.topGroup).trigger("dtsb-redrawContents")};i.prototype._andSearch=function(a){if(0===this.s.criteria.length)return!0;for(var b=0,d=this.s.criteria;b<d.length;b++){var c=d[b];if((!(c.criteria instanceof j)||c.criteria.s.filled)&&!c.criteria.search(a))return!1}return!0};
i.prototype._orSearch=function(a){if(0===this.s.criteria.length)return!0;for(var b=!1,d=0,c=this.s.criteria;d<c.length;d++){var e=c[d];if(e.criteria instanceof j&&e.criteria.s.filled){if(b=!0,e.criteria.search(a))return!0}else if(e.criteria instanceof i&&e.criteria.checkFilled()&&(b=!0,e.criteria.search(a)))return!0}return!b};i.prototype._removeCriteria=function(a,b){void 0===b&&(b=!1);if(1>=this.s.criteria.length&&this.s.isChild)this.destroy();else{for(var c=void 0,e=0;e<this.s.criteria.length;e++)if(this.s.criteria[e].index===
a.s.index&&(!b||this.s.criteria[e].criteria instanceof i))c=e;void 0!==c&&this.s.criteria.splice(c,1);for(e=0;e<this.s.criteria.length;e++)this.s.criteria[e].index=e,this.s.criteria[e].criteria.s.index=e}};i.prototype._setCriteriaListeners=function(a){var b=this;g(a.dom["delete"]).unbind("click").on("click",function(){b._removeCriteria(a);g(a.dom.container).remove();b.setupLogic();for(var c=0,e=b.s.criteria;c<e.length;c++){var h=e[c];h.criteria instanceof j&&h.criteria.updateArrows(1<b.s.criteria.length)}a.destroy();
b.s.dt.draw();g(b.s.topGroup).trigger("dtsb-updateTitle");return!1});g(a.dom.right).unbind("click").on("click",function(){var c=a.s.index,e=new i(b.s.dt,b.s.opts,b.s.topGroup,a.s.index,!0,b.s.depth+1);e.addCriteria(a);b.s.criteria[c].criteria=e;b.s.criteria[c].logic="AND";g(b.s.topGroup).trigger("dtsb-redrawContents");b._setGroupListeners(e);return!1});g(a.dom.left).unbind("click").on("click",function(){b.s.toDrop=new j(b.s.dt,b.s.opts,b.s.topGroup,a.s.index);b.s.toDrop.s=a.s;b.s.toDrop.c=a.c;b.s.toDrop.classes=
a.classes;b.s.toDrop.populate();var c=b.s.toDrop.s.index;g(b.dom.container).trigger("dtsb-dropCriteria");a.s.index=c;b._removeCriteria(a);g(b.s.topGroup).trigger("dtsb-redrawContents");b.s.dt.draw();return!1})};i.prototype._setClearListener=function(){var a=this;g(this.dom.clear).unbind("click").on("click",function(){if(!a.s.isChild)return g(a.dom.container).trigger("dtsb-clearContents"),!1;a.destroy();g(a.s.topGroup).trigger("dtsb-updateTitle");g(a.s.topGroup).trigger("dtsb-redrawContents");return!1})};
i.prototype._setGroupListeners=function(a){var b=this;g(a.dom.add).unbind("click").on("click",function(){b.setupLogic();g(b.dom.container).trigger("dtsb-add");return!1});g(a.dom.container).unbind("dtsb-add").on("dtsb-add",function(){b.setupLogic();g(b.dom.container).trigger("dtsb-add");return!1});g(a.dom.container).unbind("dtsb-destroy").on("dtsb-destroy",function(){b._removeCriteria(a,!0);g(a.dom.container).remove();b.setupLogic();return!1});g(a.dom.container).unbind("dtsb-dropCriteria").on("dtsb-dropCriteria",
...
g(this.dom.logicContainer).append(this.dom.logic).append(this.dom.clear);this.s.isChild&&g(this.dom.container).append(this.dom.logicContainer);g(this.dom.container).append(this.dom.add)};i.prototype._setLogicListener=function(){var a=this;g(this.dom.logic).unbind("click").on("click",function(){a._toggleLogic();a.s.dt.draw();for(var b=0,c=a.s.criteria;b<c.length;b++)c[b].criteria.setListeners()})};i.prototype._toggleLogic=function(){"OR"===this.s.logic?(this.s.logic="AND",g(this.dom.logic).text(this.s.dt.i18n("searchBuilder.logicAnd",
this.c.i18n.logicAnd))):"AND"===this.s.logic&&(this.s.logic="OR",g(this.dom.logic).text(this.s.dt.i18n("searchBuilder.logicOr",this.c.i18n.logicOr)))};i.version="1.0.0";i.classes={add:"dtsb-add",button:"dtsb-button",clearGroup:"dtsb-clearGroup",greyscale:"dtsb-greyscale",group:"dtsb-group",inputButton:"dtsb-iptbtn",logic:"dtsb-logic",logicContainer:"dtsb-logicContainer"};i.defaults={columns:!0,conditions:{date:j.dateConditions,html:j.stringConditions,"html-num":j.numConditions,"html-num-fmt":j.numFmtConditions,
moment:j.momentDateConditions,num:j.numConditions,"num-fmt":j.numFmtConditions,string:j.stringConditions},depthLimit:!1,filterChanged:void 0,greyscale:!1,logic:"AND",orthogonal:{conditionName:"Condition Name",search:"filter"},preDefined:!1};t=i;var h,u,x,k=function(a,b){var c=this;if(!u||!u.versionCheck||!u.versionCheck("1.10.0"))throw Error("SearchBuilder requires DataTables 1.10 or newer");var e=new u.Api(a);this.classes=h.extend(!0,{},k.classes);this.c=h.extend(!0,{},k.defaults,b);this.dom={clearAll:h('<button type="button">'+
...
function(){c._setUp()});return this}};k.prototype.getDetails=function(){return this.s.topGroup.getDetails()};k.prototype.getNode=function(){return this.dom.container};k.prototype.rebuild=function(a){h(this.dom.clearAll).click();if(void 0===a||null===a)return this;this.s.topGroup.rebuild(a);this.s.dt.draw();this.s.topGroup.setListeners();return this};k.prototype._applyPreDefDefaults=function(a){var b=this;void 0!==a.criteria&&void 0===a.logic&&(a.logic="AND");for(var c=function(a){a.criteria!==void 0?
a=e._applyPreDefDefaults(a):e.s.dt.columns().every(function(c){if(b.s.dt.settings()[0].aoColumns[c].sTitle===a.data)a.dataIdx=c})},e=this,g=0,h=a.criteria;g<h.length;g++)c(h[g]);return a};k.prototype._setUp=function(a){var b=this;void 0===a&&(a=!0);this.s.topGroup=new t(this.s.dt,this.c,void 0);this._setClearListener();this.s.dt.on("stateSaveParams",function(a,c,e){e.searchBuilder=b.getDetails();e.page=b.s.dt.page()});this._build();a&&(a=this.s.dt.state.loaded(),null!==a&&void 0!==a.searchBuilder?
(this.s.topGroup.rebuild(a.searchBuilder),h(this.s.topGroup.dom.container).trigger("dtsb-redrawContents"),this.s.dt.page(a.page).draw("page"),this.s.topGroup.setListeners()):!1!==this.c.preDefined&&(this.c.preDefined=this._applyPreDefDefaults(this.c.preDefined),this.rebuild(this.c.preDefined)));this._setEmptyListener();this.s.dt.state.save()};k.prototype._updateTitle=function(a){h(this.dom.title).text(this.s.dt.i18n("searchBuilder.title",this.c.i18n.title,a))};k.prototype._build=function(){var a=
this;h(this.dom.clearAll).remove();h(this.dom.container).empty();var b=this.s.topGroup.count();this._updateTitle(b);h(this.dom.titleRow).append(this.dom.title);h(this.dom.container).append(this.dom.titleRow);this.dom.topGroup=this.s.topGroup.getNode();h(this.dom.container).append(this.dom.topGroup);this._setRedrawListener();var c=this.s.dt.table(0).node();-1===h.fn.dataTable.ext.search.indexOf(this.s.search)&&(this.s.search=function(b,e){return b.nTable!==c?!0:a.s.topGroup.search(e)},h.fn.dataTable.ext.search.push(this.s.search));
...
return!1})};k.prototype._setRedrawListener=function(){var a=this;h(this.s.topGroup.dom.container).unbind("dtsb-redrawContents");h(this.s.topGroup.dom.container).on("dtsb-redrawContents",function(){a._checkClear();a.s.topGroup.redrawContents();a.s.topGroup.setupLogic();a._setEmptyListener();var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b);a.s.dt.state.save()});h(this.s.topGroup.dom.container).unbind("dtsb-clearContents");h(this.s.topGroup.dom.container).on("dtsb-clearContents",function(){a._setUp(!1);
a._filterChanged(0);a.s.dt.draw()});h(this.s.topGroup.dom.container).on("dtsb-updateTitle",function(){var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b)})};k.prototype._setEmptyListener=function(){var a=this;h(this.s.topGroup.dom.add).on("click",function(){a._checkClear()});h(this.s.topGroup.dom.container).on("dtsb-destroy",function(){h(a.dom.clearAll).remove()})};k.version="1.0.0";k.classes={button:"dtsb-button",clearAll:"dtsb-clearAll",container:"dtsb-searchBuilder",inputButton:"dtsb-iptbtn",
title:"dtsb-title",titleRow:"dtsb-titleRow"};k.defaults={columns:!0,conditions:{date:j.dateConditions,html:j.stringConditions,"html-num":j.numConditions,"html-num-fmt":j.numFmtConditions,moment:j.momentDateConditions,num:j.numConditions,"num-fmt":j.numFmtConditions,string:j.stringConditions},depthLimit:!1,filterChanged:void 0,greyscale:!1,i18n:{add:"Add Condition",button:{"0":"Search Builder",_:"Search Builder (%d)"},clearAll:"Clear All",condition:"Condition",data:"Data",deleteTitle:"Delete filtering rule",
leftTitle:"Outdent criteria",logicAnd:"And",logicOr:"Or",rightTitle:"Indent criteria",title:{"0":"Custom Search Builder",_:"Custom Search Builder (%d)"},value:"Value"},logic:"AND",orthogonal:{conditionName:"Condition Name",search:"filter"},preDefined:!1};x=k;var A=function(a,b,c){function f(a,b){var c=new i.Api(a),d=b?b:c.init().searchBuilder||i.defaults.searchBuilder;return(new x(c,d)).getNode()}h=a;u=a.fn.DataTable;g=a;w=a.fn.dataTable;e=a;var i=s=a.fn.dataTable;a.fn.dataTable.SearchBuilder=x;a.fn.DataTable.SearchBuilder=
x;a.fn.dataTable.Group=t;a.fn.DataTable.Group=t;a.fn.dataTable.Criteria=j;a.fn.DataTable.Criteria=j;b=a.fn.dataTable.Api.register;a.fn.dataTable.ext.searchBuilder={conditions:{}};a.fn.dataTable.ext.buttons.searchBuilder={action:function(a,b,c,d){a.stopPropagation();this.popover(d._searchBuilder.getNode(),{align:"dt-container"})},config:{},init:function(b,c,d){var e=new a.fn.dataTable.SearchBuilder(b,a.extend({filterChanged:function(a,d){b.button(c).text(d)}},d.config));b.button(c).text(d.text||b.i18n("searchBuilder.button",
e.c.i18n.button,0));d._searchBuilder=e},text:null};b("searchBuilder.getDetails()",function(){return this.context[0]._searchBuilder.getDetails()});b("searchBuilder.rebuild()",function(a){this.context[0]._searchBuilder.rebuild(a);return this});b("searchBuilder.container()",function(){return this.context[0]._searchBuilder.getNode()});a(c).on("preInit.dt.dtsp",function(a,b){if("dt"===a.namespace&&(b.oInit.searchBuilder||i.defaults.searchBuilder))b._searchBuilder||f(b)});i.ext.feature.push({cFeature:"Q",
fnInit:f});i.ext.features&&i.ext.features.register("searchBuilder",f)};"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(a){return A(a,window,document)}):"object"===typeof exports?module.exports=function(a,b){a||(a=window);if(!b||!b.fn.dataTable)b=require("datatables.net")(a,b).$;return A(b,a,a.document)}:A(window.jQuery,window,document)})();
