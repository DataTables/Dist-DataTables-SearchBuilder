...
{"0":"Custom Search Builder",_:"Custom Search Builder (%d)"},a))};m.prototype._build=function(){var a=this;h(this.dom.container).empty();var b=this.s.topGroup.count();this._updateTitle(b);h(this.dom.titleRow).append(this.dom.title);h(this.dom.container).append(this.dom.titleRow);this.dom.topGroup=this.s.topGroup.getNode();h(this.dom.container).append(this.dom.topGroup);this._setRedrawListener();var c=this.s.dt.table(0).node();-1===h.fn.dataTable.ext.search.indexOf(this.s.search)&&(this.s.search=function(b,
e){return b.nTable!==c?!0:a.s.topGroup.search(e)},h.fn.dataTable.ext.search.push(this.s.search));h.fn.DataTable.Api.registerPlural("columns().type()","column().type()",function(){return this.iterator("column",function(a,b){return a.aoColumns[b].sType},1)});this.s.dt.on("destroy.dt",function(){h(a.dom.container).remove();h(a.dom.clearAll).remove();for(var b=h.fn.dataTable.ext.search.indexOf(a.s.search);b!==-1;){h.fn.dataTable.ext.search.splice(b,1);b=h.fn.dataTable.ext.search.indexOf(a.s.search)}})};
