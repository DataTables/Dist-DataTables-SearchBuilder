...
$jscomp.polyfillUnisolated=function(k,n,m,h){m=$jscomp.global;k=k.split(".");for(h=0;h<k.length-1;h++){var q=k[h];if(!(q in m))return;m=m[q]}k=k[k.length-1];h=m[k];n=n(h);n!=h&&null!=n&&$jscomp.defineProperty(m,k,{configurable:!0,writable:!0,value:n})};
$jscomp.polyfillIsolated=function(k,n,m,h){var q=k.split(".");k=1===q.length;h=q[0];h=!k&&h in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var u=0;u<q.length-1;u++){var v=q[u];if(!(v in h))return;h=h[v]}q=q[q.length-1];m=$jscomp.IS_SYMBOL_NATIVE&&"es6"===m?h[q]:null;n=n(m);null!=n&&(k?$jscomp.defineProperty($jscomp.polyfills,q,{configurable:!0,writable:!0,value:n}):n!==m&&($jscomp.propertyToPolyfillSymbol[q]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(q):$jscomp.POLYFILL_PREFIX+q,q=
$jscomp.propertyToPolyfillSymbol[q],$jscomp.defineProperty(h,q,{configurable:!0,writable:!0,value:n})))};$jscomp.polyfill("Object.is",function(k){return k?k:function(n,m){return n===m?0!==n||1/n===1/m:n!==n&&m!==m}},"es6","es3");$jscomp.polyfill("Array.prototype.includes",function(k){return k?k:function(n,m){var h=this;h instanceof String&&(h=String(h));var q=h.length;m=m||0;for(0>m&&(m=Math.max(m+q,0));m<q;m++){var u=h[m];if(u===n||Object.is(u,n))return!0}return!1}},"es7","es3");
...
$jscomp.polyfill("Symbol",function(k){if(k)return k;var n=function(q,u){this.$jscomp$symbol$id_=q;$jscomp.defineProperty(this,"description",{configurable:!0,writable:!0,value:u})};n.prototype.toString=function(){return this.$jscomp$symbol$id_};var m=0,h=function(q){if(this instanceof h)throw new TypeError("Symbol is not a constructor");return new n("jscomp_symbol_"+(q||"")+"_"+m++,q)};return h},"es6","es3");$jscomp.initSymbolIterator=function(){};
...
"es3");$jscomp.initSymbolAsyncIterator=function(){};$jscomp.iteratorPrototype=function(k){k={next:k};k[Symbol.iterator]=function(){return this};return k};$jscomp.iteratorFromArray=function(k,n){k instanceof String&&(k+="");var m=0,h={next:function(){if(m<k.length){var q=m++;return{value:n(q,k[q]),done:!1}}h.next=function(){return{done:!0,value:void 0}};return h.next()}};h[Symbol.iterator]=function(){return h};return h};
$jscomp.polyfill("Array.prototype.keys",function(k){return k?k:function(){return $jscomp.iteratorFromArray(this,function(n){return n})}},"es6","es3");$jscomp.polyfill("String.prototype.startsWith",function(k){return k?k:function(n,m){var h=$jscomp.checkStringArgs(this,n,"startsWith");n+="";var q=h.length,u=n.length;m=Math.max(0,Math.min(m|0,h.length));for(var v=0;v<u&&m<q;)if(h[m++]!=n[v++])return!1;return v>=u}},"es6","es3");
$jscomp.polyfill("String.prototype.endsWith",function(k){return k?k:function(n,m){var h=$jscomp.checkStringArgs(this,n,"endsWith");n+="";void 0===m&&(m=h.length);m=Math.max(0,Math.min(m|0,h.length));for(var q=n.length;0<q&&0<m;)if(h[--m]!=n[--q])return!1;return 0>=q}},"es6","es3");
(function(){function k(c){h=c;q=c.fn.dataTable}function n(c){C=c;E=c.fn.dataTable}function m(c){x=c;D=c.fn.DataTable}var h,q,u=window.moment,v=window.luxon,t=function(){function c(a,b,d,e,f,g){var l=this;void 0===e&&(e=0);void 0===f&&(f=1);void 0===g&&(g=void 0);if(!q||!q.versionCheck||!q.versionCheck("1.10.0"))throw Error("SearchPane requires DataTables 1.10 or newer");this.classes=h.extend(!0,{},c.classes);this.c=h.extend(!0,{},c.defaults,h.fn.dataTable.ext.searchBuilder,b);b=this.c.i18n;this.s=
{condition:void 0,conditions:{},data:void 0,dataIdx:-1,dataPoints:[],dateFormat:!1,depth:f,dt:a,filled:!1,index:e,origData:void 0,preventRedraw:!1,serverData:g,topGroup:d,type:"",value:[]};this.dom={buttons:h("<div/>").addClass(this.classes.buttonContainer),condition:h("<select disabled/>").addClass(this.classes.condition).addClass(this.classes.dropDown).addClass(this.classes.italic).attr("autocomplete","hacking"),conditionTitle:h('<option value="" disabled selected hidden/>').html(this.s.dt.i18n("searchBuilder.condition",
b.condition)),container:h("<div/>").addClass(this.classes.container),data:h("<select/>").addClass(this.classes.data).addClass(this.classes.dropDown).addClass(this.classes.italic),dataTitle:h('<option value="" disabled selected hidden/>').html(this.s.dt.i18n("searchBuilder.data",b.data)),defaultValue:h("<select disabled/>").addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.select).addClass(this.classes.italic),"delete":h("<button/>").html(this.s.dt.i18n("searchBuilder.delete",
b["delete"])).addClass(this.classes["delete"]).addClass(this.classes.button).attr("title",this.s.dt.i18n("searchBuilder.deleteTitle",b.deleteTitle)).attr("type","button"),inputCont:h("<div/>").addClass(this.classes.inputCont),left:h("<button/>").html(this.s.dt.i18n("searchBuilder.left",b.left)).addClass(this.classes.left).addClass(this.classes.button).attr("title",this.s.dt.i18n("searchBuilder.leftTitle",b.leftTitle)).attr("type","button"),right:h("<button/>").html(this.s.dt.i18n("searchBuilder.right",
b.right)).addClass(this.classes.right).addClass(this.classes.button).attr("title",this.s.dt.i18n("searchBuilder.rightTitle",b.rightTitle)).attr("type","button"),value:[h("<select disabled/>").addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.italic).addClass(this.classes.select)],valueTitle:h('<option value="--valueTitle--" disabled selected hidden/>').html(this.s.dt.i18n("searchBuilder.value",b.value))};if(this.c.greyscale)for(this.dom.data.addClass(this.classes.greyscale),
this.dom.condition.addClass(this.classes.greyscale),this.dom.defaultValue.addClass(this.classes.greyscale),a=0,d=this.dom.value;a<d.length;a++)d[a].addClass(this.classes.greyscale);h(window).on("resize.dtsb",q.util.throttle(function(){l.s.topGroup.trigger("dtsb-redrawLogic")}));this._buildCriteria();return this}c._escapeHTML=function(a){return a.toString().replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"')};c.parseNumFmt=function(a){return+a.replace(/(?!^-)[^0-9.]/g,
"")};c.prototype.updateArrows=function(a){void 0===a&&(a=!1);this.dom.container.children().detach();this.dom.container.append(this.dom.data).append(this.dom.condition).append(this.dom.inputCont);this.dom.inputCont.empty().append(this.dom.value[0]);this.setListeners();void 0!==this.dom.value[0]&&this.dom.value[0].trigger("dtsb-inserted");for(var b=1;b<this.dom.value.length;b++)this.dom.inputCont.append(this.dom.value[b]),this.dom.value[b].trigger("dtsb-inserted");1<this.s.depth&&this.dom.buttons.append(this.dom.left);
(!1===this.c.depthLimit||this.s.depth<this.c.depthLimit)&&a?this.dom.buttons.append(this.dom.right):this.dom.right.remove();this.dom.buttons.append(this.dom["delete"]);this.dom.container.append(this.dom.buttons)};c.prototype.destroy=function(){this.dom.data.off(".dtsb");this.dom.condition.off(".dtsb");this.dom["delete"].off(".dtsb");for(var a=0,b=this.dom.value;a<b.length;a++)b[a].off(".dtsb");this.dom.container.remove()};c.prototype.search=function(a,b){var d=this.s.conditions[this.s.condition];
if(void 0!==this.s.condition&&void 0!==d){var e=a[this.s.dataIdx];if(this.s.type.includes("num")&&(""!==this.s.dt.settings()[0].oLanguage.sDecimal||""!==this.s.dt.settings()[0].oLanguage.sThousands)){e=[a[this.s.dataIdx]];""!==this.s.dt.settings()[0].oLanguage.sDecimal&&(e=a[this.s.dataIdx].split(this.s.dt.settings()[0].oLanguage.sDecimal));if(""!==this.s.dt.settings()[0].oLanguage.sThousands)for(a=0;a<e.length;a++)e[a]=e[a].replace(this.s.dt.settings()[0].oLanguage.sThousands,",");e=e.join(".")}"filter"!==
this.c.orthogonal.search&&(e=this.s.dt.settings()[0],e=e.oApi._fnGetCellData(e,b,this.s.dataIdx,"string"===typeof this.c.orthogonal?this.c.orthogonal:this.c.orthogonal.search));if("array"===this.s.type)for(Array.isArray(e)||(e=[e]),e.sort(),b=0,a=e;b<a.length;b++){var f=a[b];f&&"string"===typeof f&&f.replace(/[\r\n\u2028]/g," ")}else null!==e&&"string"===typeof e&&(e=e.replace(/[\r\n\u2028]/g," "));this.s.type.includes("html")&&"string"===typeof e&&(e=e.replace(/(<([^>]+)>)/ig,""));null===e&&(e="");
return d.search(e,this.s.value,this)}};c.prototype.getDetails=function(a){void 0===a&&(a=!1);if(null!==this.s.type&&this.s.type.includes("num")&&(""!==this.s.dt.settings()[0].oLanguage.sDecimal||""!==this.s.dt.settings()[0].oLanguage.sThousands))for(a=0;a<this.s.value.length;a++){var b=[this.s.value[a].toString()];""!==this.s.dt.settings()[0].oLanguage.sDecimal&&(b=this.s.value[a].split(this.s.dt.settings()[0].oLanguage.sDecimal));if(""!==this.s.dt.settings()[0].oLanguage.sThousands)for(var d=0;d<
b.length;d++)b[d]=b[d].replace(this.s.dt.settings()[0].oLanguage.sThousands,",");this.s.value[a]=b.join(".")}else if(null!==this.s.type&&a)if(this.s.type.includes("date")||this.s.type.includes("time"))for(a=0;a<this.s.value.length;a++)null===this.s.value[a].match(/^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])$/g)&&(this.s.value[a]="");else if(this.s.type.includes("moment"))for(a=0;a<this.s.value.length;a++)this.s.value[a]&&0<this.s.value[a].length&&u(this.s.value[a],this.s.dateFormat,!0).isValid()&&(this.s.value[a]=
u(this.s.value[a],this.s.dateFormat).format("YYYY-MM-DD HH:mm:ss"));else if(this.s.type.includes("luxon"))for(a=0;a<this.s.value.length;a++)this.s.value[a]&&0<this.s.value[a].length&&null===v.DateTime.fromFormat(this.s.value[a],this.s.dateFormat).invalid&&(this.s.value[a]=v.DateTime.fromFormat(this.s.value[a],this.s.dateFormat).toFormat("yyyy-MM-dd HH:mm:ss"));if(this.s.type.includes("num")&&this.s.dt.page.info().serverSide)for(a=0;a<this.s.value.length;a++)this.s.value[a]=this.s.value[a].replace(/[^0-9.]/g,
"");return{condition:this.s.condition,data:this.s.data,origData:this.s.origData,type:this.s.type,value:this.s.value.map(function(e){return null!==e&&void 0!==e?e.toString():e})}};c.prototype.getNode=function(){return this.dom.container};c.prototype.populate=function(){this._populateData();-1!==this.s.dataIdx&&(this._populateCondition(),void 0!==this.s.condition&&this._populateValue())};c.prototype.rebuild=function(a){var b=!1,d;this._populateData();if(void 0!==a.data){var e=this.classes.italic,f=
this.dom.data;this.dom.data.children("option").each(function(){!b&&(h(this).text()===a.data||a.origData&&h(this).prop("origData")===a.origData)?(h(this).prop("selected",!0),f.removeClass(e),b=!0,d=h(this).val()):h(this).removeProp("selected")})}if(b){this.s.data=a.data;this.s.origData=a.origData;this.s.dataIdx=d;this.c.orthogonal=this._getOptions().orthogonal;this.dom.dataTitle.remove();this._populateCondition();this.dom.conditionTitle.remove();for(var g=void 0,l=this.dom.condition.children("option"),
p=0;p<l.length;p++){var r=h(l[p]);void 0!==a.condition&&r.val()===a.condition&&"string"===typeof a.condition?(r.prop("selected",!0),g=r.val()):r.removeProp("selected")}this.s.condition=g;if(void 0!==this.s.condition){this.dom.conditionTitle.removeProp("selected");this.dom.conditionTitle.remove();this.dom.condition.removeClass(this.classes.italic);for(p=0;p<l.length;p++)r=h(l[p]),r.val()!==this.s.condition&&r.removeProp("selected");this._populateValue(a)}else this.dom.conditionTitle.prependTo(this.dom.condition).prop("selected",
!0)}};c.prototype.setListeners=function(){var a=this;this.dom.data.unbind("change").on("change.dtsb",function(){a.dom.dataTitle.removeProp("selected");for(var b=a.dom.data.children("option."+a.classes.option),d=0;d<b.length;d++){var e=h(b[d]);e.val()===a.dom.data.val()?(a.dom.data.removeClass(a.classes.italic),e.prop("selected",!0),a.s.dataIdx=+e.val(),a.s.data=e.text(),a.s.origData=e.prop("origData"),a.c.orthogonal=a._getOptions().orthogonal,a._clearCondition(),a._clearValue(),a._populateCondition(),
a.s.filled&&(a.s.filled=!1,a.s.dt.draw(),a.setListeners()),a.s.dt.state.save()):e.removeProp("selected")}});this.dom.condition.unbind("change").on("change.dtsb",function(){a.dom.conditionTitle.removeProp("selected");for(var b=a.dom.condition.children("option."+a.classes.option),d=0;d<b.length;d++){var e=h(b[d]);if(e.val()===a.dom.condition.val()){a.dom.condition.removeClass(a.classes.italic);e.prop("selected",!0);e=e.val();for(var f=0,g=Object.keys(a.s.conditions);f<g.length;f++)if(g[f]===e){a.s.condition=
e;break}a._clearValue();a._populateValue();e=0;for(f=a.dom.value;e<f.length;e++)g=f[e],a.s.filled&&void 0!==g&&0!==a.dom.inputCont.has(g[0]).length&&(a.s.filled=!1,a.s.dt.draw(),a.setListeners());(0===a.dom.value.length||1===a.dom.value.length&&void 0===a.dom.value[0])&&a.s.dt.draw()}else e.removeProp("selected")}})};c.prototype.setupButtons=function(){550<window.innerWidth?(this.dom.container.removeClass(this.classes.vertical),this.dom.buttons.css("left",null),this.dom.buttons.css("top",null)):(this.dom.container.addClass(this.classes.vertical),
this.dom.buttons.css("left",this.dom.data.innerWidth()),this.dom.buttons.css("top",this.dom.data.position().top))};c.prototype._buildCriteria=function(){this.dom.data.append(this.dom.dataTitle);this.dom.condition.append(this.dom.conditionTitle);this.dom.container.append(this.dom.data).append(this.dom.condition);this.dom.inputCont.empty();for(var a=0,b=this.dom.value;a<b.length;a++){var d=b[a];d.append(this.dom.valueTitle);this.dom.inputCont.append(d)}this.dom.buttons.append(this.dom["delete"]).append(this.dom.right);
this.dom.container.append(this.dom.inputCont).append(this.dom.buttons);this.setListeners()};c.prototype._clearCondition=function(){this.dom.condition.empty();this.dom.conditionTitle.prop("selected",!0).attr("disabled","true");this.dom.condition.prepend(this.dom.conditionTitle).prop("selectedIndex",0);this.s.conditions={};this.s.condition=void 0};c.prototype._clearValue=function(){if(void 0!==this.s.condition){if(0<this.dom.value.length&&void 0!==this.dom.value[0])for(var a=function(f){void 0!==f&&
setTimeout(function(){f.remove()},50)},b=0,d=this.dom.value;b<d.length;b++){var e=d[b];a(e)}this.dom.value=[].concat(this.s.conditions[this.s.condition].init(this,c.updateListener));if(0<this.dom.value.length&&void 0!==this.dom.value[0])for(this.dom.inputCont.empty().append(this.dom.value[0]).insertAfter(this.dom.condition),this.dom.value[0].trigger("dtsb-inserted"),e=1;e<this.dom.value.length;e++)this.dom.inputCont.append(this.dom.value[e]),this.dom.value[e].trigger("dtsb-inserted")}else{a=function(f){void 0!==
...
c.prototype._populateCondition=function(){var a=[],b=Object.keys(this.s.conditions).length,d=this.s.dt.settings()[0].aoColumns,e=+this.dom.data.children("option:selected").val();if(0===b){this.s.type=this.s.dt.columns().type().toArray()[e];if(void 0!==d)if(b=d[e],void 0!==b.searchBuilderType&&null!==b.searchBuilderType)this.s.type=b.searchBuilderType;else if(void 0===this.s.type||null===this.s.type)this.s.type=b.sType;if(null===this.s.type||void 0===this.s.type)h.fn.dataTable.ext.oApi._fnColumnTypes(this.s.dt.settings()[0]),
this.s.type=this.s.dt.columns().type().toArray()[e];this.dom.condition.removeAttr("disabled").empty().append(this.dom.conditionTitle).addClass(this.classes.italic);this.dom.conditionTitle.prop("selected",!0);b=this.s.dt.settings()[0].oLanguage.sDecimal;""!==b&&this.s.type.indexOf(b)===this.s.type.length-b.length&&(this.s.type.includes("num-fmt")?this.s.type=this.s.type.replace(b,""):this.s.type.includes("num")&&(this.s.type=this.s.type.replace(b,"")));var f=void 0!==this.c.conditions[this.s.type]?
this.c.conditions[this.s.type]:this.s.type.includes("moment")?this.c.conditions.moment:this.s.type.includes("luxon")?this.c.conditions.luxon:this.c.conditions.string;this.s.type.includes("moment")?this.s.dateFormat=this.s.type.replace(/moment-/g,""):this.s.type.includes("luxon")&&(this.s.dateFormat=this.s.type.replace(/luxon-/g,""));for(var g=0,l=Object.keys(f);g<l.length;g++){var p=l[g];null!==f[p]&&(this.s.dt.page.info().serverSide&&f[p].init===c.initSelect&&(f[p].init=this.s.serverData[d[e].data]?
c.initSelectSSP:c.initInput,f[p].inputValue=c.inputValueSelect,f[p].isInputValid=c.isInputValidSelect),this.s.conditions[p]=f[p],b=f[p].conditionName,"function"===typeof b&&(b=b(this.s.dt,this.c.i18n)),a.push(h("<option>",{text:b,value:p}).addClass(this.classes.option).addClass(this.classes.notItalic)))}}else if(0<b)for(this.dom.condition.empty().removeAttr("disabled").addClass(this.classes.italic),f=0,g=Object.keys(this.s.conditions);f<g.length;f++)p=g[f],b=this.s.conditions[p].conditionName,"function"===
typeof b&&(b=b(this.s.dt,this.c.i18n)),p=h("<option>",{text:b,value:p}).addClass(this.classes.option).addClass(this.classes.notItalic),void 0!==this.s.condition&&this.s.condition===b&&(p.prop("selected",!0),this.dom.condition.removeClass(this.classes.italic)),a.push(p);else{this.dom.condition.attr("disabled","true").addClass(this.classes.italic);return}for(b=0;b<a.length;b++)this.dom.condition.append(a[b]);if(d[e].searchBuilder&&d[e].searchBuilder.defaultCondition)if(d=d[e].searchBuilder.defaultCondition,
"number"===typeof d)this.dom.condition.prop("selectedIndex",d),this.dom.condition.trigger("change");else{if("string"===typeof d)for(e=0;e<a.length;e++)for(p=0,f=Object.keys(this.s.conditions);p<f.length;p++)if(g=f[p],b=this.s.conditions[g].conditionName,("string"===typeof b?b:b(this.s.dt,this.c.i18n))===a[e].text()&&g===d){this.dom.condition.prop("selectedIndex",this.dom.condition.children().toArray().indexOf(a[e][0])).removeClass(this.classes.italic);this.dom.condition.trigger("change");e=a.length;
break}}else this.dom.condition.prop("selectedIndex",0)};c.prototype._populateData=function(){var a=this;this.dom.data.empty().append(this.dom.dataTitle);if(0===this.s.dataPoints.length)this.s.dt.columns().every(function(g){if(!0===a.c.columns||a.s.dt.columns(a.c.columns).indexes().toArray().includes(g)){for(var l=!1,p=0,r=a.s.dataPoints;p<r.length;p++)if(r[p].index===g){l=!0;break}l||(l=a.s.dt.settings()[0].aoColumns[g],g={index:g,origData:l.data,text:(void 0===l.searchBuilderTitle?l.sTitle:l.searchBuilderTitle).replace(/(<([^>]+)>)/ig,
"")},a.s.dataPoints.push(g),a.dom.data.append(h("<option>",{text:g.text,value:g.index}).addClass(a.classes.option).addClass(a.classes.notItalic).prop("origData",l.data).prop("selected",a.s.dataIdx===g.index?!0:!1)),a.s.dataIdx===g.index&&a.dom.dataTitle.removeProp("selected"))}});else for(var b=function(g){d.s.dt.columns().every(function(p){var r=a.s.dt.settings()[0].aoColumns[p];(void 0===r.searchBuilderTitle?r.sTitle:r.searchBuilderTitle).replace(/(<([^>]+)>)/ig,"")===g.text&&(g.index=p,g.origData=
r.data)});var l=h("<option>",{text:g.text.replace(/(<([^>]+)>)/ig,""),value:g.index}).addClass(d.classes.option).addClass(d.classes.notItalic).prop("origData",g.origData);d.s.data===g.text&&(d.s.dataIdx=g.index,d.dom.dataTitle.removeProp("selected"),l.prop("selected",!0),d.dom.data.removeClass(d.classes.italic));d.dom.data.append(l)},d=this,e=0,f=this.s.dataPoints;e<f.length;e++)b(f[e])};c.prototype._populateValue=function(a){var b=this,d=this.s.filled;this.s.filled=!1;setTimeout(function(){b.dom.defaultValue.remove()},
50);for(var e=function(l){setTimeout(function(){void 0!==l&&l.remove()},50)},f=0,g=this.dom.value;f<g.length;f++)e(g[f]);e=this.dom.inputCont.children();if(1<e.length)for(f=0;f<e.length;f++)h(e[f]).remove();void 0!==a&&this.s.dt.columns().every(function(l){b.s.dt.settings()[0].aoColumns[l].sTitle===a.data&&(b.s.dataIdx=l)});this.dom.value=[].concat(this.s.conditions[this.s.condition].init(this,c.updateListener,void 0!==a?a.value:void 0));void 0!==a&&void 0!==a.value&&(this.s.value=a.value);this.dom.inputCont.empty();
void 0!==this.dom.value[0]&&this.dom.value[0].appendTo(this.dom.inputCont).trigger("dtsb-inserted");for(f=1;f<this.dom.value.length;f++)this.dom.value[f].insertAfter(this.dom.value[f-1]).trigger("dtsb-inserted");this.s.filled=this.s.conditions[this.s.condition].isInputValid(this.dom.value,this);this.setListeners();this.s.preventRedraw||d===this.s.filled||(this.s.dt.page.info().serverSide||this.s.dt.draw(),this.setListeners())};c.prototype._throttle=function(a,b){void 0===b&&(b=200);var d=null,e=null,
...
left:"dtsb-left",notItalic:"dtsb-notItalic",option:"dtsb-option",right:"dtsb-right",select:"dtsb-select",value:"dtsb-value",vertical:"dtsb-vertical"};c.initSelect=function(a,b,d,e){void 0===d&&(d=null);void 0===e&&(e=!1);var f=a.dom.data.children("option:selected").val(),g=a.s.dt.rows().indexes().toArray(),l=a.s.dt.settings()[0];a.dom.valueTitle.prop("selected",!0);var p=h("<select/>").addClass(c.classes.value).addClass(c.classes.dropDown).addClass(c.classes.italic).addClass(c.classes.select).append(a.dom.valueTitle).on("change.dtsb",
function(){h(this).removeClass(c.classes.italic);b(a,this)});a.c.greyscale&&p.addClass(c.classes.greyscale);for(var r=[],B=[],H=0;H<g.length;H++){var z=g[H],A=l.oApi._fnGetCellData(l,z,f,"string"===typeof a.c.orthogonal?a.c.orthogonal:a.c.orthogonal.search);A="string"===typeof A?A.replace(/[\r\n\u2028]/g," "):A;z=l.oApi._fnGetCellData(l,z,f,"string"===typeof a.c.orthogonal?a.c.orthogonal:a.c.orthogonal.display);"array"===a.s.type&&(A=Array.isArray(A)?A:[A],z=Array.isArray(z)?z:[z]);var J=function(w,
y){a.s.type.includes("html")&&null!==w&&"string"===typeof w&&w.replace(/(<([^>]+)>)/ig,"");w=h("<option>",{type:Array.isArray(w)?"Array":"String",value:w}).data("sbv",w).addClass(a.classes.option).addClass(a.classes.notItalic).html("string"===typeof y?y.replace(/(<([^>]+)>)/ig,""):y);y=w.val();-1===r.indexOf(y)&&(r.push(y),B.push(w),null!==d&&Array.isArray(d[0])&&(d[0]=d[0].sort().join(",")),null!==d&&w.val()===d[0]&&(w.prop("selected",!0),p.removeClass(c.classes.italic),a.dom.valueTitle.removeProp("selected")))};
if(e)for(var F=0;F<A.length;F++)J(A[F],z[F]);else J(A,Array.isArray(z)?z.join(", "):z)}B.sort(function(w,y){if("array"===a.s.type||"string"===a.s.type||"html"===a.s.type)return w.val()<y.val()?-1:w.val()>y.val()?1:0;if("num"===a.s.type||"html-num"===a.s.type)return+w.val().replace(/(<([^>]+)>)/ig,"")<+y.val().replace(/(<([^>]+)>)/ig,"")?-1:+w.val().replace(/(<([^>]+)>)/ig,"")>+y.val().replace(/(<([^>]+)>)/ig,"")?1:0;if("num-fmt"===a.s.type||"html-num-fmt"===a.s.type)return+w.val().replace(/[^0-9.]/g,
"")<+y.val().replace(/[^0-9.]/g,"")?-1:+w.val().replace(/[^0-9.]/g,"")>+y.val().replace(/[^0-9.]/g,"")?1:0});for(e=0;e<B.length;e++)p.append(B[e]);return p};c.initSelectSSP=function(a,b,d){void 0===d&&(d=null);a.dom.valueTitle.prop("selected",!0);var e=h("<select/>").addClass(c.classes.value).addClass(c.classes.dropDown).addClass(c.classes.italic).addClass(c.classes.select).append(a.dom.valueTitle).on("change.dtsb",function(){h(this).removeClass(c.classes.italic);b(a,this)});a.c.greyscale&&e.addClass(c.classes.greyscale);
for(var f=[],g=0,l=a.s.serverData[a.s.origData];g<l.length;g++){var p=l[g];(function(r,B){a.s.type.includes("html")&&null!==r&&"string"===typeof r&&r.replace(/(<([^>]+)>)/ig,"");r=h("<option>",{type:Array.isArray(r)?"Array":"String",value:r}).data("sbv",r).addClass(a.classes.option).addClass(a.classes.notItalic).html("string"===typeof B?B.replace(/(<([^>]+)>)/ig,""):B);f.push(r);null!==d&&r.val()===d[0]&&(r.prop("selected",!0),e.removeClass(c.classes.italic),a.dom.valueTitle.removeProp("selected"))})(p.value,
...
"button"),container:x("<div/>").addClass(this.classes.container),title:x("<div/>").addClass(this.classes.title),titleRow:x("<div/>").addClass(this.classes.titleRow),topGroup:void 0};this.s={dt:a,opts:b,search:void 0,serverData:void 0,topGroup:void 0};if(void 0===a.settings()[0]._searchBuilder){a.settings()[0]._searchBuilder=this;this.s.dt.page.info().serverSide&&(this.s.dt.on("preXhr.dtsb",function(e,f,g){(e=d.s.dt.state.loaded())&&e.searchBuilder&&(g.searchBuilder=d._collapseArray(e.searchBuilder))}),
...
p)})},e=this,f=0,g=a.criteria;f<g.length;f++)d(g[f]);return a};c.prototype._setUp=function(a){var b=this;void 0===a&&(a=!0);x.fn.DataTable.Api.registerPlural("columns().type()","column().type()",function(){return this.iterator("column",function(l,p){return l.aoColumns[p].sType},1)});if(!D.DateTime){var d=this.s.dt.columns().type().toArray();if(void 0===d||d.includes(void 0)||d.includes(null)){d=[];for(var e=0,f=this.s.dt.settings()[0].aoColumns;e<f.length;e++){var g=f[e];d.push(void 0!==g.searchBuilderType?
...
}this.s.topGroup=new G(this.s.dt,this.c,void 0,void 0,void 0,void 0,this.s.serverData);this._setClearListener();this.s.dt.on("stateSaveParams.dtsb",function(l,p,r){r.searchBuilder=b.getDetails();r.scroller?r.start=b.s.dt.state().start:r.page=b.s.dt.page()});this.s.dt.on("stateLoadParams.dtsb",function(l,p,r){b.rebuild(r.searchBuilder)});this._build();this.s.dt.on("preXhr.dtsb",function(l,p,r){b.s.dt.page.info().serverSide&&(r.searchBuilder=b._collapseArray(b.getDetails(!0)))});this.s.dt.on("column-reorder",
...
g=g?g:f.init().searchBuilder||e.defaults.searchBuilder;return(new I(f,g)).getNode()}m(c);n(c);k(c);var e=c.fn.dataTable;c.fn.dataTable.SearchBuilder=I;c.fn.DataTable.SearchBuilder=I;c.fn.dataTable.Group=G;c.fn.DataTable.Group=G;c.fn.dataTable.Criteria=t;c.fn.DataTable.Criteria=t;a=c.fn.dataTable.Api.register;c.fn.dataTable.ext.searchBuilder={conditions:{}};c.fn.dataTable.ext.buttons.searchBuilder={action:function(f,g,l,p){this.popover(p._searchBuilder.getNode(),{align:"container",span:"container"});
f=p._searchBuilder.s.topGroup;void 0!==f&&f.dom.container.trigger("dtsb-redrawContents-noDraw");0===f.s.criteria.length&&c("."+c.fn.dataTable.Group.classes.add.replace(/ /g,".")).click()},config:{},init:function(f,g,l){var p=new c.fn.dataTable.SearchBuilder(f,c.extend({filterChanged:function(r,B){f.button(g).text(B)}},l.config));f.button(g).text(l.text||f.i18n("searchBuilder.button",p.c.i18n.button,0));l._searchBuilder=p},text:null};a("searchBuilder.getDetails()",function(f){void 0===f&&(f=!1);var g=
