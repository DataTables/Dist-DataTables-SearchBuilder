...
"-minutes")){b.s.d.setUTCMinutes(c);b._setTime();b._writeOutput(true);f()}else if(e.hasClass(d+"-seconds")){b.s.d.setSeconds(c);b._setTime();b._writeOutput(true);f()}b.dom.input.focus();b._position()}).on("click",function(e){var c=b.s.d,o=e.target.nodeName.toLowerCase(),i=o==="span"?e.target.parentNode:e.target,o=i.nodeName.toLowerCase();if(o!=="select"){e.stopPropagation();if(o==="button"){i=a(i);e=i.parent();if(e.hasClass("disabled")&&!e.hasClass("range"))i.blur();else if(e.hasClass(d+"-iconLeft")){b.s.display.setUTCMonth(b.s.display.getUTCMonth()-
1);b._setTitle();b._setCalander();b.dom.input.focus()}else if(e.hasClass(d+"-iconRight")){b._correctMonth(b.s.display,b.s.display.getUTCMonth()+1);b._setTitle();b._setCalander();b.dom.input.focus()}else{if(i.parents("."+d+"-time").length){o=i.data("value");i=i.data("unit");if(i==="minutes"){if(e.hasClass("disabled")&&e.hasClass("range")){b.s.minutesRange=o;b._setTime();return}b.s.minutesRange=null}if(i==="seconds"){if(e.hasClass("disabled")&&e.hasClass("range")){b.s.secondsRange=o;b._setTime();return}b.s.secondsRange=
null}if(o==="am")if(c.getUTCHours()>=12)o=c.getUTCHours()-12;else return;else if(o==="pm")if(c.getUTCHours()<12)o=c.getUTCHours()+12;else return;c[i==="hours"?"setUTCHours":i==="minutes"?"setUTCMinutes":"setSeconds"](o);b._setTime();b._writeOutput(true)}else{c||(c=b._dateToUtc(new Date));c.setUTCDate(1);c.setUTCFullYear(i.data("year"));c.setUTCMonth(i.data("month"));c.setUTCDate(i.data("day"));b._writeOutput(true);b.s.parts.time?b._setCalander():setTimeout(function(){b._hide()},10)}f()}}else b.dom.input.focus()}})},
...
a.selected&&b.push("selected");return'<td data-day="'+a.day+'" class="'+b.join(" ")+'"><button class="'+d+"-button "+d+'-day" type="button" data-year="'+a.year+'" data-month="'+a.month+'" data-day="'+a.day+'"><span>'+a.day+"</span></button></td>"},_htmlMonth:function(b,d){var f=this._dateToUtc(new Date),e=this._daysInMonth(b,d),c=(new Date(Date.UTC(b,d,1))).getUTCDay(),o=[],i=[];0<this.c.firstDay&&(c-=this.c.firstDay,0>c&&(c+=7));for(var g=e+c,h=g;7<h;)h-=7;var g=g+(7-h),j=this.c.minDate,h=this.c.maxDate;
j&&(j.setUTCHours(0),j.setUTCMinutes(0),j.setSeconds(0));h&&(h.setUTCHours(23),h.setUTCMinutes(59),h.setSeconds(59));for(var k=0,m=0;k<g;k++){var l=new Date(Date.UTC(b,d,1+(k-c))),n=this.s.d?this._compareDates(l,this.s.d):!1,A=this._compareDates(l,f),r=k<c||k>=e+c,x=j&&l<j||h&&l>h,u=this.c.disableDays;a.isArray(u)&&-1!==a.inArray(l.getUTCDay(),u)?x=!0:"function"===typeof u&&!0===u(l)&&(x=!0);i.push(this._htmlDay({day:1+(k-c),month:d,year:b,selected:n,today:A,disabled:x,empty:r}));7===++m&&(this.c.showWeekNumber&&
i.unshift(this._htmlWeekOfYear(k-c,d,b)),o.push("<tr>"+i.join("")+"</tr>"),i=[],m=0)}f=this.c.classPrefix;e=f+"-table";this.c.showWeekNumber&&(e+=" weekNumber");j&&(j=j>=new Date(Date.UTC(b,d,1,0,0,0)),this.dom.title.find("div."+f+"-iconLeft").css("display",j?"none":"block"));h&&(h=h<new Date(Date.UTC(b,d+1,1,0,0,0)),this.dom.title.find("div."+f+"-iconRight").css("display",h?"none":"block"));return'<table class="'+e+'"><thead>'+this._htmlMonthHead()+"</thead><tbody>"+o.join("")+"</tbody></table>"},
...
this.c.classPrefix+"-"+a);a.empty();for(var f=0,e=b.length;f<e;f++)a.append('<option value="'+b[f]+'">'+d[f]+"</option>")},_optionSet:function(a,b){var d=this.dom.container.find("select."+this.c.classPrefix+"-"+a),f=d.parent().children("span");d.val(b);d=d.find("option:selected");f.html(0!==d.length?d.text():this.c.i18n.unknown)},_optionsTime:function(b,d,f,e,c){var o=this.c.classPrefix,i=this.dom.container.find("div."+o+"-"+b),g,h=12===d?function(a){return a}:this._pad,o=this.c.classPrefix,j=o+"-table",
k=this.c.i18n;if(i.length){var m="";g=10;var l=function(c,i,g){12===d&&(12<=f&&"number"===typeof c)&&(c+=12);var h=f===c||"am"===c&&12>f||"pm"===c&&12<=f?"selected":"";e&&-1===a.inArray(c,e)&&(h+=" disabled");g&&(h+=" "+g);return'<td class="selectable '+h+'"><button class="'+o+"-button "+o+'-day" type="button" data-unit="'+b+'" data-value="'+c+'"><span>'+i+"</span></button></td>"};if(12===d){m+="<tr>";for(c=1;6>=c;c++)m+=l(c,h(c));m+=l("am",k.amPm[0]);m+="</tr><tr>";for(c=7;12>=c;c++)m+=l(c,h(c));
m+=l("pm",k.amPm[1]);m+="</tr>";g=7}else{if(24===d){var n=0;for(g=0;4>g;g++){m+="<tr>";for(c=0;6>c;c++)m+=l(n,h(n)),n++;m+="</tr>"}}else{m+="<tr>";for(g=0;60>g;g+=10)m+=l(g,h(g),"range");c=null!==c?c:10*Math.floor(f/10);m=m+"</tr>"+('</tbody></thead><table class="'+j+" "+j+'-nospace"><tbody>')+"<tr>";for(g=c+1;g<c+10;g++)m+=l(g,h(g));m+="</tr>"}g=6}i.empty().append('<table class="'+j+'"><thead><tr><th colspan="'+g+'">'+k[b]+"</th></tr></thead><tbody>"+m+"</tbody></table>")}},_optionsTitle:function(){var a=
...
this.s.parts.time&&550<a(b).width()?f.addClass("horizontal"):f.removeClass("horizontal");"input"===this.c.attachTo?f.css({top:d.top+c,left:d.left}).insertAfter(this.dom.input):f.css({top:d.top+c,left:d.left}).appendTo("body");var e=f.outerHeight(),o=f.outerWidth(),i=a(b).scrollTop();d.top+c+e-i>a(b).height()&&(c=d.top-e,f.css("top",0>c?0:c));o+d.left>a(b).width()&&(d=a(b).width()-o,f.css("left",0>d?0:d))},_range:function(a,b,d){var f=[];for(d||(d=1);a<=b;a+=d)f.push(a);return f},_setCalander:function(){this.s.display&&
...
r,n=window.moment,k,c=function(a,b,d,f,o){var i=this;void 0===f&&(f=0);void 0===o&&(o=1);if(!r||!r.versionCheck||!r.versionCheck("1.10.0"))throw Error("SearchPane requires DataTables 1.10 or newer");this.classes=e.extend(!0,{},c.classes);this.c=e.extend(!0,{},c.defaults,e.fn.dataTable.ext.searchBuilder,b);this.s={condition:void 0,conditions:new Map,data:void 0,dataIdx:-1,dataPoints:[],depth:o,dt:a,filled:!1,index:f,momentFormat:!1,topGroup:d,type:"",value:[]};this.dom={buttons:e("<div/>").addClass(this.classes.buttonContainer),
...
option:"dtsb-option",right:"dtsb-right",value:"dtsb-value",vertical:"dtsb-vertical"};c.initSelect=function(a,b,d){void 0===d&&(d=null);for(var f=e(a.dom.data).children("option:selected").val(),g=a.s.dt.rows().indexes().toArray(),i=a.s.dt.settings()[0],h=e("<select/>").addClass(c.classes.value).addClass(c.classes.dropDown).addClass(c.classes.italic).append(a.dom.valueTitle).on("input",function(){e(this).removeClass(c.classes.italic);b(a,this)}),j=[],k=[],l=0;l<g.length;l++){var n=g[l],q=i.oApi._fnGetCellData(i,
n,f,a.c.orthogonal.search),n=i.oApi._fnGetCellData(i,n,f,"display"),q=e("<option>",{text:a.s.type.includes("html")?n.replace(/(<([^>]+)>)/ig,""):n,value:a.s.type.includes("html")?q.replace(/(<([^>]+)>)/ig,""):q}).addClass(a.classes.option).addClass(a.classes.notItalic),n=e(q).val();-1===j.indexOf(n)&&(j.push(n),k.push(q),null!==d&&q.val()===d[0]&&(q.attr("selected",!0),a.dom.valueTitle.remove(),e(h).removeClass(c.classes.italic)))}k.sort(function(b,d){if("string"===a.s.type||"num"===a.s.type||"html"===
a.s.type||"html-num"===a.s.type)return e(b).val()<e(d).val()?-1:e(b).val()<e(d).val()?1:0;if("num-fmt"===a.s.type||"html-num-fmt"===a.s.type)return+e(b).val().replace(/[^0-9.]/g,"")<+e(d).val().replace(/[^0-9.]/g,"")?-1:+e(b).val().replace(/[^0-9.]/g,"")<+e(d).val().replace(/[^0-9.]/g,"")?1:0});for(d=0;d<k.length;d++)q=k[d],e(h).append(q);return h};c.initInput=function(a,b,d){void 0===d&&(d=null);var f=e("<input/>").addClass(c.classes.value).addClass(c.classes.input).on("input",function(){b(a,this)});
...
d){return n(a,d.s.momentFormat).valueOf()!==n(b[0],d.s.momentFormat).valueOf()}},"!between":{conditionName:"Not Between",init:c.init2Date,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,d){var a=n(a,d.s.momentFormat).valueOf(),c=n(b[0],d.s.momentFormat).valueOf(),b=n(b[1],d.s.momentFormat).valueOf();return c<b?!(+c<=+a&&+a<=+b):!(+b<=+a&&+a<=+c)}},"!null":{conditionName:"Not Empty",isInputValid:function(){return!0},init:function(){},inputValue:function(){},search:function(a){return!(null===
a||void 0===a||0===a.length)}},"<":{conditionName:"Before",init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,d){return n(a,d.s.momentFormat).valueOf()<n(b[0],d.s.momentFormat).valueOf()}},"=":{conditionName:"Equals",init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,d){return n(a,d.s.momentFormat).valueOf()===n(b[0],d.s.momentFormat).valueOf()}},">":{conditionName:"After",init:c.initDate,inputValue:c.inputValueInput,
isInputValid:c.isInputValidInput,search:function(a,b,d){return n(a,d.s.momentFormat).valueOf()>n(b[0],d.s.momentFormat).valueOf()}},between:{conditionName:"Between",init:c.init2Date,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b,d){var a=n(a,d.s.momentFormat).valueOf(),c=n(b[0],d.s.momentFormat).valueOf(),b=n(b[1],d.s.momentFormat).valueOf();return c<b?c<=a&&a<=b:b<=a&&a<=c}},"null":{conditionName:"Empty",isInputValid:function(){return!0},init:function(){},inputValue:function(){},
...
a.classes);c.populate();for(var e=!1,i=0;i<this.s.criteria.length;i++)0===i&&this.s.criteria[i].criteria.s.index>c.s.index?(g(c.getNode()).insertBefore(this.s.criteria[i].criteria.dom.container),e=!0):i<this.s.criteria.length-1&&(this.s.criteria[i].criteria.s.index<c.s.index&&this.s.criteria[i+1].criteria.s.index>c.s.index)&&(g(c.getNode()).insertAfter(this.s.criteria[i].criteria.dom.container),e=!0);e||g(c.getNode()).insertBefore(this.dom.add);this.s.criteria.push({criteria:c,index:d});this.s.criteria=
this.s.criteria.sort(function(a,b){return a.criteria.s.index-b.criteria.s.index});d=0;for(e=this.s.criteria;d<e.length;d++)i=e[d],i.criteria instanceof k&&i.criteria.updateArrows(1<this.s.criteria.length,b);this._setCriteriaListeners(c);c.setListeners();this.setupLogic()};j.prototype.checkFilled=function(){for(var a=0,b=this.s.criteria;a<b.length;a++){var d=b[a];if(d.criteria instanceof k&&d.criteria.s.filled||d.criteria instanceof j&&d.criteria.checkFilled())return!0}return!1};j.prototype.count=
...
"OR",g(this.dom.logic).text(this.s.dt.i18n("searchBuilder.logicOr","Or")))};j.version="1.0.0";j.classes={add:"dtsb-add",button:"dtsb-button",clearGroup:"dtsb-clearGroup",greyscale:"dtsb-greyscale",group:"dtsb-group",inputButton:"dtsb-iptbtn",logic:"dtsb-logic",logicContainer:"dtsb-logicContainer"};j.defaults={columns:!0,conditions:{date:k.dateConditions,html:k.stringConditions,"html-num":k.numConditions,"html-num-fmt":k.numFmtConditions,moment:k.momentDateConditions,num:k.numConditions,"num-fmt":k.numFmtConditions,
string:k.stringConditions},depthLimit:!1,filterChanged:void 0,greyscale:!1,logic:"AND",orthogonal:{conditionName:"Condition Name",search:"filter"},preDefined:!1};s=j;var h,t,w,l=function(a,b){var c=this;if(!t||!t.versionCheck||!t.versionCheck("1.10.0"))throw Error("SearchBuilder requires DataTables 1.10 or newer");var e=new t.Api(a);this.classes=h.extend(!0,{},l.classes);this.c=h.extend(!0,{},l.defaults,b);this.dom={clearAll:h('<button type="button">'+e.i18n("searchBuilder.clearAll","Clear All")+
"</button>").addClass(this.classes.clearAll).addClass(this.classes.button),container:h("<div/>").addClass(this.classes.container),title:h("<div/>").addClass(this.classes.title),titleRow:h("<div/>").addClass(this.classes.titleRow),topGroup:void 0};this.s={dt:e,opts:b,search:void 0,topGroup:void 0};if(void 0===e.settings()[0]._searchBuilder){e.settings()[0]._searchBuilder=this;if(this.s.dt.settings()[0]._bInitComplete)this._setUp();else e.one("init.dt",function(){c._setUp()});return this}};l.prototype.getDetails=
function(){return this.s.topGroup.getDetails()};l.prototype.getNode=function(){return this.dom.container};l.prototype.rebuild=function(a){h(this.dom.clearAll).click();if(void 0===a||null===a)return this;this.s.topGroup.rebuild(a);this.s.dt.draw();this.s.topGroup.setListeners();return this};l.prototype._applyPreDefDefaults=function(a){var b=this;void 0!==a.criteria&&void 0===a.logic&&(a.logic="AND");for(var c=function(a){a.criteria!==void 0?a=e._applyPreDefDefaults(a):e.s.dt.columns().every(function(c){if(b.s.dt.settings()[0].aoColumns[c].sTitle===
a.data)a.dataIdx=c})},e=this,g=0,i=a.criteria;g<i.length;g++)c(i[g]);return a};l.prototype._setUp=function(a){var b=this;void 0===a&&(a=!0);this.s.topGroup=new s(this.s.dt,this.c,void 0);this._setClearListener();this.s.dt.on("stateSaveParams",function(a,c,e){e.searchBuilder=b.getDetails();e.page=b.s.dt.page()});this._build();a&&(a=this.s.dt.state.loaded(),null!==a&&void 0!==a.searchBuilder?(this.s.topGroup.rebuild(a.searchBuilder),h(this.s.topGroup.dom.container).trigger("dtsb-redrawContents"),this.s.dt.page(a.page).draw("page"),
this.s.topGroup.setListeners()):!1!==this.c.preDefined&&(this.c.preDefined=this._applyPreDefDefaults(this.c.preDefined),this.rebuild(this.c.preDefined)));this._setEmptyListener();this.s.dt.state.save()};l.prototype._updateTitle=function(a){h(this.dom.title).text(this.s.dt.i18n("searchBuilder.title",{"0":"Custom Search Builder",_:"Custom Search Builder (%d)"},a))};l.prototype._build=function(){var a=this;h(this.dom.clearAll).remove();h(this.dom.container).empty();var b=this.s.topGroup.count();this._updateTitle(b);
h(this.dom.titleRow).append(this.dom.title);h(this.dom.container).append(this.dom.titleRow);this.dom.topGroup=this.s.topGroup.getNode();h(this.dom.container).append(this.dom.topGroup);this._setRedrawListener();var c=this.s.dt.table(0).node();-1===h.fn.dataTable.ext.search.indexOf(this.s.search)&&(this.s.search=function(b,e){return b.nTable!==c?!0:a.s.topGroup.search(e)},h.fn.dataTable.ext.search.push(this.s.search));h.fn.DataTable.Api.registerPlural("columns().type()","column().type()",function(){return this.iterator("column",
function(a,b){return a.aoColumns[b].sType},1)});this.s.dt.on("destroy.dt",function(){h(a.dom.container).remove();h(a.dom.clearAll).remove();for(var b=h.fn.dataTable.ext.search.indexOf(a.s.search);b!==-1;){h.fn.dataTable.ext.search.splice(b,1);b=h.fn.dataTable.ext.search.indexOf(a.s.search)}})};l.prototype._checkClear=function(){0<this.s.topGroup.s.criteria.length?(h(this.dom.clearAll).insertAfter(this.dom.title),this._setClearListener()):h(this.dom.clearAll).remove()};l.prototype._setClearListener=
function(){var a=this;h(this.dom.clearAll).unbind("click");h(this.dom.clearAll).on("click",function(){a.s.topGroup=new s(a.s.dt,a.s.opts,void 0);a._build();a.s.dt.draw();a.s.topGroup.setListeners();h(a.dom.clearAll).remove();a._setEmptyListener();void 0!==a.c.filterChanged&&"function"===typeof a.c.filterChanged&&a.c.filterChanged(0);return!1})};l.prototype._setRedrawListener=function(){var a=this;h(this.s.topGroup.dom.container).unbind("dtsb-redrawContents");h(this.s.topGroup.dom.container).on("dtsb-redrawContents",
function(){a._checkClear();a.s.topGroup.redrawContents();a.s.topGroup.setupLogic();a._setEmptyListener();var b=a.s.topGroup.count();a._updateTitle(b);void 0!==a.c.filterChanged&&"function"===typeof a.c.filterChanged&&a.c.filterChanged(b);a.s.dt.state.save()});h(this.s.topGroup.dom.container).unbind("dtsb-clearContents");h(this.s.topGroup.dom.container).on("dtsb-clearContents",function(){a._setUp(!1);void 0!==a.c.filterChanged&&"function"===typeof a.c.filterChanged&&a.c.filterChanged(0);a.s.dt.draw()});
h(this.s.topGroup.dom.container).on("dtsb-updateTitle",function(){var b=a.s.topGroup.count();a._updateTitle(b);void 0!==a.c.filterChanged&&"function"===typeof a.c.filterChanged&&a.c.filterChanged(b)})};l.prototype._setEmptyListener=function(){var a=this;h(this.s.topGroup.dom.add).on("click",function(){a._checkClear()});h(this.s.topGroup.dom.container).on("dtsb-destroy",function(){h(a.dom.clearAll).remove()})};l.version="1.0.0";l.classes={button:"dtsb-button",clearAll:"dtsb-clearAll",container:"dtsb-searchBuilder",
inputButton:"dtsb-iptbtn",title:"dtsb-title",titleRow:"dtsb-titleRow"};l.defaults={columns:!0,conditions:{date:k.dateConditions,html:k.stringConditions,"html-num":k.numConditions,"html-num-fmt":k.numFmtConditions,moment:k.momentDateConditions,num:k.numConditions,"num-fmt":k.numFmtConditions,string:k.stringConditions},depthLimit:!1,filterChanged:void 0,greyscale:!1,logic:"AND",orthogonal:{conditionName:"Condition Name",search:"filter"},preDefined:!1};w=l;var z=function(a,b,c){function f(a){var a=new j.Api(a),
b=a.init().searchBuilder||j.defaults.searchBuilder;return(new w(a,b)).getNode()}h=a;t=a.fn.DataTable;g=a;v=a.fn.dataTable;e=a;var j=r=a.fn.dataTable;a.fn.dataTable.SearchBuilder=w;a.fn.DataTable.SearchBuilder=w;a.fn.dataTable.Group=s;a.fn.DataTable.Group=s;a.fn.dataTable.Criteria=k;a.fn.DataTable.Criteria=k;b=a.fn.dataTable.Api.register;a.fn.dataTable.ext.searchBuilder={conditions:{}};a.fn.dataTable.ext.buttons.searchBuilder={action:function(a,b,c,d){a.stopPropagation();this.popover(d._searchBuilder.getNode(),
{align:"dt-container"})},config:{},init:function(b,c,d){var e=new a.fn.dataTable.SearchBuilder(b,a.extend({filterChanged:function(a){b.button(c).text(b.i18n("searchBuilder.button",{"0":"Search Builder",_:"Search Builder (%d)"},a))}},d.config)),f=b.i18n("searchBuilder.button","Search Builder",0);b.button(c).text(f);d._searchBuilder=e},text:"Search Builder"};b("searchBuilder.getDetails()",function(){return this.context[0]._searchBuilder.getDetails()});b("searchBuilder.rebuild()",function(a){this.context[0]._searchBuilder.rebuild(a);
