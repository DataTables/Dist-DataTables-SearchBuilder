...
"OR",g(this.dom.logic).text(this.s.dt.i18n("searchBuilder.logicOr","Or")))};j.version="0.0.1";j.classes={add:"dtsb-add",button:"dtsb-button",clearGroup:"dtsb-clearGroup",greyscale:"dtsb-greyscale",group:"dtsb-group",inputButton:"dtsb-iptbtn",logic:"dtsb-logic",logicContainer:"dtsb-logicContainer"};j.defaults={depthLimit:!1,greyscale:!1,logic:"AND"};s=j;var h,t,w,m=function(a,b){var c=this;console.log("colin");if(!t||!t.versionCheck||!t.versionCheck("1.10.0"))throw Error("SearchBuilder requires DataTables 1.10 or newer");
