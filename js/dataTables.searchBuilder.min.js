...
l=Object.keys(f);g<l.length;g++){var p=l[g];null!==f[p]&&(this.s.dt.page.info().serverSide&&f[p].init===c.initSelect&&(b=d[e],f[p].init=this.s.serverData&&this.s.serverData[b.data]?c.initSelectSSP:c.initInput,f[p].inputValue=c.inputValueSelect,f[p].isInputValid=c.isInputValidSelect),this.s.conditions[p]=f[p],b=f[p].conditionName,"function"===typeof b&&(b=b(this.s.dt,this.c.i18n)),a.push(h("<option>",{text:b,value:p}).addClass(this.classes.option).addClass(this.classes.notItalic)))}}else if(0<b)for(this.dom.condition.empty().removeAttr("disabled").addClass(this.classes.italic),
