...
1]).trigger("dtsb-inserted");this.s.filled=this.s.conditions[this.s.condition].isInputValid(this.dom.value,this);this.setListeners();d!==this.s.filled&&(this.s.dt.draw(),this.setListeners())};c.prototype._throttle=function(){for(var a=[],b=0;b<arguments.length;b++)a[b]=arguments[b];var d=null,e=null,g=this,h=a[0],p=null!==a[1]?a[1]:200;return function(){var u=+new Date;null!==d&&u<d+p?clearTimeout(e):d=u;e=setTimeout(function(){d=null;h.apply(g,a)},p)}};c.version="1.1.0";c.classes={button:"dtsb-button",
...
g=f("<input/>").addClass(c.classes.value).addClass(c.classes.input).on("input keypress",a.c.enterSearch?function(h){a._throttle(function(){if(13===(h.keyCode||h.which))return b(a,this)},null===e?100:e)}:a._throttle(function(){return b(a,this)},null===e?100:e));a.c.greyscale&&f(g).addClass(c.classes.greyscale);null!==d&&f(g).val(d[0]);a.s.dt.one("draw",function(){f(a.s.topGroup).trigger("dtsb-redrawLogic")});return g};c.init2Input=function(a,b,d){void 0===d&&(d=null);var e=a.s.dt.settings()[0].searchDelay,
...
(h.keyCode||h.which))return b(a,this)},null===e?100:e)}:a._throttle(function(){return b(a,this)},null===e?100:e))];a.c.greyscale&&(f(g[0]).addClass(c.classes.greyscale),f(g[2]).addClass(c.classes.greyscale));null!==d&&(f(g[0]).val(d[0]),f(g[2]).val(d[1]));a.s.dt.one("draw",function(){f(a.s.topGroup).trigger("dtsb-redrawLogic")});return g};c.initDate=function(a,b,d){void 0===d&&(d=null);var e=a.s.dt.settings()[0].searchDelay,g=f("<input/>").addClass(c.classes.value).addClass(c.classes.input).dtDateTime({attachTo:"input",
format:a.s.dateFormat?a.s.dateFormat:void 0}).on("change",a._throttle(function(){return b(a,this)},null===e?100:e)).on("input keypress",a.c.enterSearch?function(h){a._throttle(function(){if(13===(h.keyCode||h.which))return b(a,this)},null===e?100:e)}:a._throttle(function(){return b(a,this)},null===e?100:e));a.c.greyscale&&f(g).addClass(c.classes.greyscale);null!==d&&f(g).val(d[0]);a.s.dt.one("draw",function(){f(a.s.topGroup).trigger("dtsb-redrawLogic")});return g};c.initNoValue=function(a){a.s.dt.one("draw",
function(){f(a.s.topGroup).trigger("dtsb-redrawLogic")})};c.init2Date=function(a,b,d){var e=this;void 0===d&&(d=null);var g=a.s.dt.settings()[0].searchDelay;g=[f("<input/>").addClass(c.classes.value).addClass(c.classes.input).dtDateTime({attachTo:"input",format:a.s.dateFormat?a.s.dateFormat:void 0}).on("change",null!==g?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},g):function(){b(a,e)}).on("input keypress",a.c.enterSearch||null===g?a.c.enterSearch?function(h){13===(h.keyCode||
h.which)&&b(a,e)}:function(){b(a,e)}:a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},g)),f("<span>").addClass(a.classes.joiner).text(a.s.dt.i18n("searchBuilder.valueJoiner",a.c.i18n.valueJoiner)),f("<input/>").addClass(c.classes.value).addClass(c.classes.input).dtDateTime({attachTo:"input",format:a.s.dateFormat?a.s.dateFormat:void 0}).on("change",null!==g?a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},g):function(){b(a,e)}).on("input keypress",a.c.enterSearch||
null===g?a.c.enterSearch?function(h){13===(h.keyCode||h.which)&&b(a,e)}:function(){b(a,e)}:a.s.dt.settings()[0].oApi._fnThrottle(function(){return b(a,this)},g))];a.c.greyscale&&(f(g[0]).addClass(c.classes.greyscale),f(g[2]).addClass(c.classes.greyscale));null!==d&&0<d.length&&(f(g[0]).val(d[0]),f(g[2]).val(d[1]));a.s.dt.one("draw",function(){f(a.s.topGroup).trigger("dtsb-redrawLogic")});return g};c.isInputValidSelect=function(a){for(var b=!0,d=0;d<a.length;d++){var e=a[d];f(e).children("option:selected").length===
f(e).children("option").length-f(e).children("option."+c.classes.notItalic).length&&1===f(e).children("option:selected").length&&f(e).children("option:selected")[0]===f(e).children("option:hidden")[0]&&(b=!1)}return b};c.isInputValidInput=function(a){for(var b=!0,d=0;d<a.length;d++){var e=a[d];f(e).is("input")&&0===f(e).val().length&&(b=!1)}return b};c.inputValueSelect=function(a){for(var b=[],d=0;d<a.length;d++){var e=a[d];if(f(e).is("select")){var g=f(e).children("option:selected").val();b.push("Array"===
f(e).children("option:selected").attr("type")?g.split(",").sort():g)}}return b};c.inputValueInput=function(a){for(var b=[],d=0;d<a.length;d++){var e=a[d];f(e).is("input")&&b.push(f(e).val())}return b};c.updateListener=function(a,b){var d=a.s.conditions[a.s.condition];a.s.filled=d.isInputValid(a.dom.value,a);a.s.value=d.inputValue(a.dom.value,a);if(a.s.filled){Array.isArray(a.s.value)||(a.s.value=[a.s.value]);for(d=0;d<a.s.value.length;d++)if(Array.isArray(a.s.value[d]))a.s.value[d].sort();else if(-1!==
a.s.type.indexOf("num")&&(""!==a.s.dt.settings()[0].oLanguage.sDecimal||""!==a.s.dt.settings()[0].oLanguage.sThousands)){var e=[a.s.value[d].toString()];""!==a.s.dt.settings()[0].oLanguage.sDecimal&&(e=a.s.value[d].split(a.s.dt.settings()[0].oLanguage.sDecimal));if(""!==a.s.dt.settings()[0].oLanguage.sThousands)for(var g=0;g<e.length;g++)e[g]=e[g].replace(a.s.dt.settings()[0].oLanguage.sThousands,",");a.s.value[d]=e.join(".")}g=e=null;for(d=0;d<a.dom.value.length;d++)b===a.dom.value[d][0]&&(e=d,void 0!==
b.selectionStart&&(g=b.selectionStart));a.s.dt.draw();null!==e&&(f(a.dom.value[e]).removeClass(a.classes.italic),f(a.dom.value[e]).focus(),null!==g&&f(a.dom.value[e])[0].setSelectionRange(g,g))}};c.dateConditions={"=":{conditionName:function(a,b){return a.i18n("searchBuilder.conditions.date.equals",b.conditions.date.equals)},init:c.initDate,inputValue:c.inputValueInput,isInputValid:c.isInputValidInput,search:function(a,b){a=a.replace(/(\/|-|,)/g,"-");return a===b[0]}},"!=":{conditionName:function(a,
...
q(this.s.topGroup.dom.container).on("dtsb-redrawLogic",function(){a.s.topGroup.redrawLogic();var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b)});q(this.s.topGroup.dom.container).on("dtsb-add",function(){var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b)});q(this.s.dt).on("postEdit postCreate postRemove",function(){a.s.topGroup.redrawContents()});q(this.s.topGroup.dom.container).unbind("dtsb-clearContents");q(this.s.topGroup.dom.container).on("dtsb-clearContents",function(){a._setUp(!1);
a._filterChanged(0);a.s.dt.draw()});q(this.s.topGroup.dom.container).on("dtsb-updateTitle",function(){var b=a.s.topGroup.count();a._updateTitle(b);a._filterChanged(b)})};c.prototype._setEmptyListener=function(){var a=this;q(this.s.topGroup.dom.add).on("click",function(){a._checkClear()});q(this.s.topGroup.dom.container).on("dtsb-destroy",function(){q(a.dom.clearAll).remove()})};c.version="1.1.0";c.classes={button:"dtsb-button",clearAll:"dtsb-clearAll",container:"dtsb-searchBuilder",inputButton:"dtsb-iptbtn",
