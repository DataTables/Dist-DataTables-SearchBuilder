...
h=a.s.dt.rows().indexes().toArray(),p=a.s.dt.settings()[0],u=f("<select/>").addClass(c.classes.value).addClass(c.classes.dropDown).addClass(c.classes.italic).addClass(c.classes.select).append(a.dom.valueTitle).on("change",function(){f(this).removeClass(c.classes.italic);b(a,this)});a.c.greyscale&&f(u).addClass(c.classes.greyscale);for(var x=[],C=[],H=0;H<h.length;H++){var B=h[H],z=p.oApi._fnGetCellData(p,B,g,"string"===typeof a.c.orthogonal?a.c.orthogonal:a.c.orthogonal.search);z="string"===typeof z?
z.replace(/[\r\n\u2028]/g," "):z;B=p.oApi._fnGetCellData(p,B,g,"string"===typeof a.c.orthogonal?a.c.orthogonal:a.c.orthogonal.display);"array"===a.s.type&&(z=Array.isArray(z)?z=z.sort():[z],B=Array.isArray(B)?B=B.sort():[B]);var J=function(y,A){y=f("<option>",{type:Array.isArray(y)?"Array":"String",value:-1!==a.s.type.indexOf("html")&&null!==y&&"string"===typeof y?y.replace(/(<([^>]+)>)/ig,""):y}).addClass(a.classes.option).addClass(a.classes.notItalic).html("string"===typeof A?A.replace(/(<([^>]+)>)/ig,
""):A);A=f(y).val();-1===x.indexOf(A)&&(x.push(A),C.push(y),null!==d&&Array.isArray(d[0])&&(d[0]=d[0].sort().join(",")),null!==d&&y.val()===d[0]&&(y.attr("selected",!0),f(u).removeClass(c.classes.italic)))};if(e)for(var F=0;F<z.length;F++)J(z[F],B[F]);else J(z,B)}C.sort(function(y,A){if("array"===a.s.type||"string"===a.s.type||"num"===a.s.type||"html"===a.s.type||"html-num"===a.s.type)return f(y).val()<f(A).val()?-1:f(y).val()>f(A).val()?1:0;if("num-fmt"===a.s.type||"html-num-fmt"===a.s.type)return+f(y).val().replace(/[^0-9.]/g,
"")<+f(A).val().replace(/[^0-9.]/g,"")?-1:+f(y).val().replace(/[^0-9.]/g,"")>+f(A).val().replace(/[^0-9.]/g,"")?1:0});for(e=0;e<C.length;e++)g=C[e],f(u).append(g);return u};c.initSelectArray=function(a,b,d){void 0===d&&(d=null);return c.initSelect(a,b,d,!0)};c.initInput=function(a,b,d){void 0===d&&(d=null);var e=a.s.dt.settings()[0].searchDelay,g=f("<input/>").addClass(c.classes.value).addClass(c.classes.input).on("input keypress",a.c.enterSearch?function(h){a._throttle(function(){if(13===(h.keyCode||
h.which))return b(a,this)},null===e?100:e)}:a._throttle(function(){return b(a,this)},null===e?100:e));a.c.greyscale&&f(g).addClass(c.classes.greyscale);null!==d&&f(g).val(d[0]);a.s.dt.one("draw",function(){f(a.s.topGroup).trigger("dtsb-redrawLogic")});return g};c.init2Input=function(a,b,d){void 0===d&&(d=null);var e=a.s.dt.settings()[0].searchDelay,g=[f("<input/>").addClass(c.classes.value).addClass(c.classes.input).on("input keypress",a.c.enterSearch?function(h){a._throttle(function(){if(13===(h.keyCode||
...
this;void 0===a&&(a=!0);q.fn.DataTable.Api.registerPlural("columns().type()","column().type()",function(p,u){return this.iterator("column",function(x,C){return x.aoColumns[C].sType},1)});if(!D.DateTime){var d=this.s.dt.columns().type().toArray(),e=this.s.dt.columns().toArray();void 0===d&&(this.s.dt.draw(),d=this.s.dt.columns().type().toArray());for(var g=0;g<e[0].length;g++){var h=d[e[0][g]];if((!0===this.c.columns||Array.isArray(this.c.columns)&&-1!==this.c.columns.indexOf(g))&&(-1!==h.indexOf("date")||
-1!==h.indexOf("moment")||-1!==h.indexOf("luxon")))throw alert("SearchBuilder Requires DateTime when used with dates."),Error("SearchBuilder requires DateTime");}}this.s.topGroup=new G(this.s.dt,this.c,void 0);this._setClearListener();this.s.dt.on("stateSaveParams",function(p,u,x){x.searchBuilder=b.getDetails();x.page=b.s.dt.page()});this._build();a&&(a=this.s.dt.state.loaded(),null!==a&&void 0!==a.searchBuilder?(this.s.topGroup.rebuild(a.searchBuilder),q(this.s.topGroup.dom.container).trigger("dtsb-redrawContents"),
